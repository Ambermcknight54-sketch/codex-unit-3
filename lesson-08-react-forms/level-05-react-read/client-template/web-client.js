...
var require_bson = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/bson.js"(
    ...
    var isObjectId = (v2) =>
      !!v2 && typeof v2 === "object" && v2._bsontype === "ObjectId";
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/client.js"(
    ...
    var DatabaseClient = class {
      ...
      get client() {
        if (!this._client) {
          throw new Error(
            "[Database] client accessed before connect() resolved",
          );
        }
        return this._client;
      }
      ...
      async adopt(client, dbName) {
        ...
        this._connecting = (async () => {
          ...
          console.log(
            `[Database] connected to ${this._db.databaseName} (injected client)`,
          );
        })();
      ...
      async connect() {
        ...
        this._connecting = (async () => {
          ...
          if (this._db.databaseName === "test" && !uri.includes("/test")) {
            console.warn(
              '[Database] connected to default "test" db \u2014 check DATABASE_URL',
            );
          }
...
var require_core = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/schema/core.js"(
    ...
    var Field = class _Field {
      ...
      default(value) {
        let d2;
        if (value === "now") d2 = { kind: "now" };
        else if (value === "autoId") d2 = { kind: "autoId" };
        else d2 = { kind: "literal", value };
    ...
    exports.f = {
      ...
      geoPoint: (opts = {}) => {
        ...
        if (dims !== 2 && dims !== 3) {
          throw new Error(
            `[forge] f.geoPoint({ dims }): dims must be 2 or 3, got ${dims}`,
          );
        }
      ...
      vector: (dims, opts = {}) => {
        if (!Number.isInteger(dims) || dims <= 0) {
          throw new Error(
            `[forge] f.vector(dims): dims must be a positive integer, got ${dims}`,
          );
        }
    ...
    var enums = (values) => {
      const out = { values };
      for (const v2 of values) out[v2] = v2;
      return out;
    };
    exports.enums = enums;
    ...
    function mapFieldDefs(fields) {
      const out = {};
      for (const k of Object.keys(fields)) out[k] = fields[k].def;
      return out;
    }
  },
});
...
var require_active = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/schema/active.js"(
    ...
    function getActiveSchema() {
      if (!_active) {
        throw new Error(
          "[forge] no active schema set. Import forge's schema module, or call createDb({ schema }) with your model map before querying.",
        );
      }
      return _active;
    }
...
var require_schema = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/schema/index.js"(
    ...
    exports.schema =
      ...
      exports.Profile =
      exports.User =
      exports.RevisionEmbed =
      exports.SocialLinkEmbed =
      exports.AddressEmbed =
      exports.LikeKind =
      exports.PostStatus =
      exports.Role =
        void 0;
    ...
    exports.Post = (0, core_2.model)(
      ...
      {
        indexes: [{ keys: { author_id: 1, status: 1 } }, { keys: { slug: 1 } }],
      },
    ).relate(() => ({
      author: rel3.one("user", {
        on: "author_id",
        refs: "id",
        onDelete: "Cascade",
      }),
    ...
    exports.Comment = (0, core_2.model)(
      "comments",
      {
        id: core_1.f.id(),
    ...
    exports.PostTag = (0, core_2.model)(
      "post_tags",
      {
        id: core_1.f.id(),
        post_id: core_1.f.objectId(),
    ...
    exports.AuditLog = (0, core_2.model)(
      "audit_logs",
      {
        id: core_1.f.id(),
...
var require_coerce = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/coerce.js"(
    ...
    var idStringToObjectId = (v2) => {
      ...
      if (v2 instanceof (0, bson_1.mongo)().ObjectId) return v2;
    ...
    function coerceFieldValue(field, value) {
      ...
      if (
        ...
        !(value instanceof (0, bson_1.mongo)().ObjectId)
      ) {
        const out = {};
        let isOp = false;
    ...
    function coerceEmbed(value, fields) {
      ...
      for (const k of Object.keys(out)) {
        const f3 = fields[k];
        if (f3) out[k] = coerceFieldValue(f3, out[k]);
      }
      return out;
    }
    ...
    function getFieldDef(model3, appKey) {
      if (appKey === "_id") return model3.fields["id"];
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/errors.js"(
    ...
    function rethrowMongoError(err, model3) {
      if (err && (err.code === DUP_KEY_MONGO || err.code === "11000")) {
        ...
        throw new DbKnownError(
          "P2002",
          `Unique constraint failed on ${model3}`,
          {
    ...
    function notFoundError(model3, where) {
      return new DbKnownError(
        "P2025",
        `No ${model3} found matching the given criteria`,
        { modelName: model3, cause: where },
      );
    }
  },
});
    ...
    function buildCursor(cursor) {
      ...
      for (const key of Object.keys(cursor)) {
        ...
        if (
          ...
          for (const inner of Object.keys(v2)) fields[inner] = v2[inner];
        } else {
          fields[key] = v2;
        }
      }
        ...
        for (const key of Object.keys(entry)) {
          ...
          if (typeof v2 === "object") {
            if (v2.nearTo) {
              ...
              if (
                typeof v2.nearTo === "object" &&
                typeof v2.nearTo.lng === "number" &&
                typeof v2.nearTo.lat === "number"
              ) {
                out.push({
                  field: key,
                  direction: v2.direction === "desc" ? "desc" : "asc",
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/ir/build/projection.js"(
    ...
    function buildProjection(model3, args, schema) {
      ...
      if (args.omit && !args.select && !args.include) {
        ...
        return {
          projection: { fields: [], omit: drop, counts: [], exclusive: false },
        };
      }
      if (args.include) {
        const hydration = [];
        ...
        for (const key of Object.keys(args.include)) {
          ...
          if (!rel3) continue;
          hydration.push(
            toRelationPlan(key, rel3, v2 === true ? {} : v2, schema),
          );
        }
        const omitFields = args.omit
          ? Object.keys(args.omit).filter((k) => args.omit[k])
          : void 0;
        return {
          projection:
            counts.length || omitFields?.length
    ...
    function toRelationPlan(name, rel3, nestedArgs, schema) {
      ...
      const hasNested =
        ...
        nestedArgs.where ||
        nestedArgs.orderBy ||
        nestedArgs.take !== void 0 ||
        nestedArgs.skip !== void 0 ||
        nestedArgs.limit !== void 0 ||
        nestedArgs.offset !== void 0 ||
        nestedArgs.distinct;
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/col.js"(
    ...
    function isColRef(v2) {
      return (
        typeof v2 === "object" &&
        v2 !== null &&
        typeof v2[exports.FORGE_COL] === "string"
      );
    }
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/ir/build/where.js"(
    ...
    function resolveColRef(model3, op, ref) {
      if (!COL_REF_OPS.has(op)) {
        throw new Error(
          `[forge] col() can only be used with equals/not/lt/lte/gt/gte (got operator '${op}' on '${model3.collection}').`,
        );
      }
      ...
      if (!fieldDef) {
        throw new Error(
          `[forge] col('${field}') references a field that does not exist on '${model3.collection}'.`,
        );
      }
      if (fieldDef.kind === "relation") {
        throw new Error(
          `[forge] col('${field}') must reference a scalar field, not a relation, on '${model3.collection}'.`,
        );
      }
      return field;
    }
    function buildWhereTree(model3, where, schema) {
      if (!where || typeof where !== "object") return void 0;
      const children = [];
      const relations = model3.relations();
      for (const key of Object.keys(where)) {
        ...
        if (key === "AND") {
          ...
          const inner = arr
            .map((v2) => buildWhereTree(model3, v2, schema))
            .filter(notUndef);
        ...
        if (rel3 && value && typeof value === "object") {
          ...
          for (const mode of ["is", "isNot", "some", "every", "none"]) {
            if (mode in value) {
              const nested =
                buildWhereTree(targetModel, value[mode], schema) ?? null;
        ...
        if ((0, col_1.isColRef)(value)) {
          ...
          if ("near" in value && value.near && typeof value.near === "object") {
            ...
            if (fdef?.kind === "vector") {
              ...
              if (fdef.vector?.dims && n2.vector.length !== fdef.vector.dims) {
                throw new Error(
                  `[forge] where.${key}.near.vector length ${n2.vector.length} does not match the column dims ${fdef.vector.dims}.`,
                );
              }
              children.push({
                kind: "leaf",
          ...
          if (
            ...
            if (
              ...
              throw new Error(
                `[forge] where.${key}.path can only be used on json / embed / array fields. '${key}' is kind=${fdef?.kind ?? "unknown"}.`,
              );
            }
            const pathArr =
    ...
    function normaliseWithinPolygon(key, raw) {
      ...
      if (!raw || typeof raw !== "object") {
        throw new Error(
          `[forge] where.${key}.withinPolygon must be a ring, Polygon, MultiPolygon, or GeometryCollection.`,
        );
      }
      const obj = raw;
      if (obj.type === "Polygon") {
        if (!Array.isArray(obj.rings) || obj.rings.length === 0) {
          throw new Error(
            `[forge] where.${key}.withinPolygon: Polygon needs at least one ring in 'rings'.`,
          );
        }
      ...
      if (obj.type === "MultiPolygon") {
        if (!Array.isArray(obj.polygons) || obj.polygons.length === 0) {
          throw new Error(
            `[forge] where.${key}.withinPolygon: MultiPolygon needs at least one polygon in 'polygons'.`,
          );
        }
        return obj.polygons.map((p2) => {
          if (!Array.isArray(p2) || p2.length === 0) {
            throw new Error(
              `[forge] where.${key}.withinPolygon: each MultiPolygon entry needs at least one ring.`,
            );
          }
      ...
      if (obj.type === "GeometryCollection") {
        if (!Array.isArray(obj.geometries) || obj.geometries.length === 0) {
          throw new Error(
            `[forge] where.${key}.withinPolygon: GeometryCollection needs entries in 'geometries'.`,
          );
        }
        const out = [];
      ...
      throw new Error(
        `[forge] where.${key}.withinPolygon: unsupported type '${String(obj.type)}'.`,
      );
    }
    function validateAndCloseRing(key, ring) {
      if (!Array.isArray(ring) || ring.length < 3) {
        throw new Error(
          `[forge] where.${key}.withinPolygon: each ring needs at least 3 vertices.`,
        );
      }
      const pts = [];
    ...
    function parseJsonPath(s) {
      ...
      for (const t of tokens) {
        ...
        if (!match) {
          throw new Error(
            `[forge] invalid JSON path segment: '${t}' in '${s}'`,
          );
        }
...
var require_build = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/ir/build/index.js"(
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.buildCursor =
      exports.buildUpdateData =
      exports.buildProjection =
      exports.buildOrderBy =
      exports.buildWhereTree =
        void 0;
    ...
    Object.defineProperty(exports, "buildCursor", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "buildOrderBy", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "buildProjection", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "buildUpdateData", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "buildWhereTree", {
      enumerable: true,
      get: function () {
    ...
    function buildSelect(modelKey, model3, args, cardinality, schema) {
      const a2 = args ?? {};
      const { projection, hydration } = (0, projection_1.buildProjection)(
        model3,
        a2,
        schema,
      );
    ...
    function materialiseHydration(hydration, schema) {
      ...
      return hydration.map((rp) => {
        ...
        const sub = buildSelect(
          target,
          targetModel,
          raw,
          rp.kind === "one" ? "one" : "many",
          schema,
        );
    ...
    function buildInsert(modelKey, model3, args, schema) {
      const { projection, hydration } = args.returning
        ? (0, projection_1.buildProjection)(model3, args.returning, schema)
        : {};
      return {
        kind: "insert",
        model: modelKey,
    ...
    var AGG_BUCKETS = /* @__PURE__ */ new Set([
      "_count",
      "_avg",
      "_sum",
      "_min",
...
var require_wkt = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/shared/wkt.js"(
    ...
    function ringWKT(ring, axis) {
      return ring
        .map((p2) =>
          axis === "lat-lng" ? `${p2.lat} ${p2.lng}` : `${p2.lng} ${p2.lat}`,
        )
        .join(", ");
    }
      ...
      for (const polygon of mp) {
        for (const ring of polygon) {
          for (const p2 of ring) {
            if (p2.lng < minLng) minLng = p2.lng;
            if (p2.lng > maxLng) maxLng = p2.lng;
    ...
    function toGeoJson(mp) {
      ...
      return {
        ...
        coordinates: mp.map((polygon) =>
          polygon.map((ring) => ring.map((p2) => [p2.lng, p2.lat])),
        ),
      };
    }
  },
...
var require_compile_from_ir = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/compile-from-ir.js"(
    ...
    function modelDef(modelKey, override) {
      ...
      if (!m2) throw new Error(`[forge] unknown model '${modelKey}' in IR`);
      return m2;
    }
      ...
      switch (tree.kind) {
        case "and": {
          const parts = tree.children
            .map((c) => compileWhereNode(model3, c))
            .filter(nonEmpty);
    ...
    function compileLeaf(model3, leaf) {
      ...
      if (leaf.rhsField !== void 0) {
        ...
        if (!exprOp) {
          throw new Error(
            `[forge] col() comparison not supported for op '${leaf.op}'`,
          );
        }
        return {
          $expr: {
            [exprOp]: [
              "$" + dbKey,
              "$" + (0, coerce_1.appKeyToDbKey)(leaf.rhsField),
            ],
          },
        };
      }
      ...
      const coerce = (v2) =>
        def ? (0, coerce_1.coerceFieldValue)(def, v2) : v2;
      const out = {};
      switch (leaf.op) {
        case "eq":
        ...
        case "gte":
          ...
          return out;
        case "contains":
          out[dbKey] = leaf.caseInsensitive
        ...
        case "jsonPath": {
          ...
          const v2 = leaf.value;
          if (op === "eq") out[dotted] = v2;
          else if (op === "ne") out[dotted] = { $ne: v2 };
          else if (op === "lt") out[dotted] = { $lt: v2 };
          else if (op === "lte") out[dotted] = { $lte: v2 };
          else if (op === "gt") out[dotted] = { $gt: v2 };
          else if (op === "gte") out[dotted] = { $gte: v2 };
          else if (op === "in") out[dotted] = { $in: v2 };
          else if (op === "contains")
            out[dotted] = { $regex: escapeRegex(String(v2)) };
          else if (op === "has") out[dotted] = v2;
          return out;
        }
        case "near": {
        ...
        case "withinPolygon": {
          const v2 = leaf.value;
          const multiPolygon =
            v2.multiPolygon ?? (v2.polygon ? [[v2.polygon]] : []);
          out[dbKey] = {
            $geoWithin: {
    ...
    function compileProjection(plan) {
      ...
      if (plan.omit?.length && plan.fields.length === 0) {
        const out = {};
        for (const f3 of plan.omit) out[(0, coerce_1.appKeyToDbKey)(f3)] = 0;
        return out;
      }
      if (plan.exclusive && plan.fields.length) {
        const out = {};
        for (const f3 of plan.fields) out[(0, coerce_1.appKeyToDbKey)(f3)] = 1;
        out._id = 1;
        return out;
      }
      return void 0;
    ...
    function compileOrderBy(orderBy) {
      if (!orderBy?.length) return void 0;
      return orderBy.map((e) => [
        (0, coerce_1.appKeyToDbKey)(e.field),
        e.direction === "desc" ? -1 : 1,
      ]);
    }
    function compileCursor(model3, cursor) {
      if (!cursor?.fields) return void 0;
      const out = {};
      for (const key of Object.keys(cursor.fields)) {
        const def = (0, coerce_1.getFieldDef)(model3, key);
        const v2 = def
          ? (0, coerce_1.coerceFieldValue)(def, cursor.fields[key])
          : cursor.fields[key];
    ...
    function compileUpdate(node, modelOverride) {
      ...
      if (node.unset?.length) {
        update.$unset = Object.fromEntries(
          node.unset.map((k) => [(0, coerce_1.appKeyToDbKey)(k), ""]),
        );
      }
    ...
    function compileGroupBy(node, modelOverride) {
      ...
      if (node.where) {
        ...
        if (Object.keys(f3).length) pipeline.push({ $match: f3 });
      }
      const groupId = {};
      ...
      if (node.orderBy?.length) {
        ...
        for (const e of node.orderBy) {
          const path = node.by.includes(e.field)
            ? `_id.${e.field}`
            : (0, coerce_1.appKeyToDbKey)(e.field);
...
var require_compile = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/compile.js"(
    ...
    function requireSoftDeleteField(model3, op) {
      ...
      if (!sd) {
        throw new Error(
          `[forge] compile.${op}() requires a field declared with .softDeleteAt() on model '${model3.collection}'. Use compile.delete()/compile.deleteMany() for hard deletes.`,
        );
      }
      return sd;
    }
    function buildMongoCompileApi(model3) {
      ...
      return {
        findFirst: (args) =>
          (0, compile_from_ir_1.compileSelect)(
            (0, build_1.buildSelect)(mk, model3, args, "one"),
            model3,
          ),
        findUnique: (args) =>
          (0, compile_from_ir_1.compileSelect)(
        ...
        findMany: (args) =>
          (0, compile_from_ir_1.compileSelect)(
            (0, build_1.buildSelect)(mk, model3, args, "many"),
            model3,
          ),
        count: (args) =>
          (0, compile_from_ir_1.compileCount)(
            (0, build_1.buildCount)(mk, model3, args),
            model3,
          ),
        create: (args) => {
          const row = (0, coerce_1.coerceCreatePayload)(model3, args.data);
          return (0, compile_from_ir_1.compileInsert)(
            (0, build_1.buildInsert)(mk, model3, {
              rows: [row],
              returning: args,
            }),
            model3,
        ...
        createMany: (args) => {
          const rows = (args.data ?? []).map((d2) =>
            (0, coerce_1.coerceCreatePayload)(model3, d2),
          );
          return (0, compile_from_ir_1.compileInsert)(
            (0, build_1.buildInsert)(mk, model3, {
              rows,
        ...
        update: (args) =>
          (0, compile_from_ir_1.compileUpdate)(
            (0, build_1.buildUpdate)(mk, model3, {
              where: args.where,
              data: args.data,
              many: false,
              returning: args,
        ...
        upsert: (args) => {
          const upsertCreate = (0, coerce_1.coerceCreatePayload)(
            model3,
            args.create,
          );
          return (0, compile_from_ir_1.compileUpdate)(
            (0, build_1.buildUpdate)(mk, model3, {
              where: args.where,
              data: args.update,
              many: false,
        ...
        delete: (args) =>
          (0, compile_from_ir_1.compileDelete)(
            (0, build_1.buildDelete)(mk, model3, {
              where: args.where,
              many: false,
              returning: args,
            }),
        ...
        softDelete: (args) => {
          ...
          const art = (0, compile_from_ir_1.compileUpdate)(
            (0, build_1.buildUpdate)(mk, model3, {
              where: args.where,
        ...
        aggregate: (args) => ({
          ...
          op: "aggregate",
          args: {
            pipeline: (0, coerce_1.coerceExtendedJSON)(args.pipeline ?? []),
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/postgres/dialect.js"(
    ...
    exports.PostgresDialect = {
      ...
      quoteIdent(name) {
        if (/["\0]/.test(name)) {
          throw new Error(
            `[forge:postgres] invalid identifier: ${JSON.stringify(name)}`,
          );
        }
        return `"${name}"`;
      },
      ...
      valueExpr(field, params, value) {
        if (
          ...
          const srid = field.geo?.srid ?? 4326;
          const wkt =
            field.geo?.dims === 3 && typeof v2.alt === "number"
              ? `SRID=${srid};POINT Z(${v2.lng} ${v2.lat} ${v2.alt})`
              : `SRID=${srid};POINT(${v2.lng} ${v2.lat})`;
      ...
      geoNearClause(quotedCol, field, point, params) {
        ...
        if (point.withinMeters === void 0) return "TRUE";
      ...
      vectorDistanceClause(quotedCol, field, query, params) {
        ...
        if (query.withinDistance === void 0) return "TRUE";
...
var require_compile_from_ir2 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/postgres/compile-from-ir.js"(
      ...
      switch (leaf.op) {
        ...
        case "contains":
          return likeOp(
            ctx,
            col,
            `%${escapeForLike(String(leaf.value))}%`,
        ...
        case "jsonPath": {
          ...
          switch (subOp) {
            case "eq":
              return leaf.value === null
                ? `${rendered} IS NULL`
                : `${rendered} = ${ph2(coerceJsonOperand(leaf.value))}`;
            case "ne":
              return leaf.value === null
        ...
        case "near": {
          ...
          if (fld.kind === "vector") {
            ...
            if (!ctx.d.vectorDistanceClause) {
              throw new Error(
                `[forge] dialect '${ctx.d.name}' does not implement vectorDistanceClause`,
              );
            }
          ...
          if (fld.kind !== "geoPoint") {
            throw new Error(
              `[forge] where.${leaf.field}.near requires a geoPoint or vector field.`,
            );
          }
          const point = leaf.value;
          if (fld.geo?.fallback) {
          ...
          if (!ctx.d.geoNearClause) {
            throw new Error(
              `[forge] dialect '${ctx.d.name}' does not implement geoNearClause`,
            );
          }
        ...
        case "withinPolygon": {
          ...
          if (!fld || fld.kind !== "geoPoint") {
            throw new Error(
              `[forge] where.${leaf.field}.withinPolygon requires a geoPoint field.`,
            );
          }
          const v2 = leaf.value;
          const multiPolygon =
          ...
          if (multiPolygon.length === 0) {
            throw new Error(
              `[forge] where.${leaf.field}.withinPolygon: empty polygon set.`,
            );
          }
          if (fld.geo?.fallback) {
          ...
          if (!ctx.d.geoWithinPolygonClause) {
            throw new Error(
              `[forge] dialect '${ctx.d.name}' does not implement geoWithinPolygonClause`,
            );
          }
          return ctx.d.geoWithinPolygonClause(
            col,
            fld,
            multiPolygon,
            ctx.params,
    ...
    function polygonBboxPrefilter(ctx, field, multiPolygon) {
      const { minLng, maxLng, minLat, maxLat } = (0, wkt_1.multiPolygonBbox)(
        multiPolygon,
      );
      const ph = (v2) => ctx.d.placeholder(ctx.params, v2);
    ...
    function haversineBboxPrefilter(ctx, field, point) {
      ...
      const lngDeg =
        radiusM / (111320 * Math.cos((point.lat * Math.PI) / 180) || 1e-9);
      const ph = (v2) => ctx.d.placeholder(ctx.params, v2);
      const lngCol = `(${ctx.table}.${ctx.d.quoteIdent(field)}->>'lng')::float8`;
      const latCol = `(${ctx.table}.${ctx.d.quoteIdent(field)}->>'lat')::float8`;
    ...
    function compileRelationFilter(ctx, tree) {
      ...
      if (!rel3) return "TRUE";
      const targetModel =
        ctx.schemaOverride?.[rel3.target] ?? schema_1.schema[rel3.target];
    ...
    function compileProjectionCols(d2, table, model3, plan) {
      if (!plan) {
        const cols = Object.keys(model3.fields).map(
          (f3) => `${table}.${d2.quoteIdent(f3)}`,
        );
        return cols.join(", ");
      }
      if (plan.exclusive && plan.fields.length) {
        return plan.fields
          .map((f3) => `${table}.${d2.quoteIdent(f3)}`)
          .join(", ");
      }
      if (plan.omit?.length) {
        const drop = new Set(plan.omit);
        const cols = Object.keys(model3.fields)
          .filter((f3) => !drop.has(f3))
          .map((f3) => `${table}.${d2.quoteIdent(f3)}`);
        return cols.join(", ");
      }
      return Object.keys(model3.fields)
        .map((f3) => `${table}.${d2.quoteIdent(f3)}`)
        .join(", ");
    }
    function compileOrder(d2, table, orderBy, model3) {
      ...
      const parts = orderBy.map((e) => {
        if (e.nearTo) {
          ...
          const alias =
            fld?.kind === "vector" ? "_distance" : "_distanceMeters";
          return d2.orderClause(d2.quoteIdent(alias), e.direction);
        }
        return d2.orderClause(
          `${table}.${d2.quoteIdent(e.field)}`,
          e.direction,
          e.nulls,
        );
      });
    ...
    function compileCursor(d2, table, params, cursor) {
      ...
      const vals = keys
        .map((k) => d2.placeholder(params, cursor.fields[k]))
        .join(", ");
      return `(${cols}) > (${vals})`;
    }
    function compileSelect(
      node,
      modelOverride,
      dialect = dialect_1.PostgresDialect,
      schemaOverride,
    ) {
      const m2 = modelDef(node.model, modelOverride);
      const params = [];
      ...
      const distinctClause = node.distinct?.length
        ? `DISTINCT ON (${node.distinct.map((f3) => `${table}.${dialect.quoteIdent(f3)}`).join(", ")}) `
        : "";
      ...
      if (nearToEntry?.nearTo) {
        ...
        if (!fld) {
          throw new Error(
            `[forge] orderBy.${nearToEntry.field}.nearTo: unknown field.`,
          );
        }
        if (fld.kind === "vector") {
          ...
          if (!Array.isArray(nt2.vector)) {
            throw new Error(
              `[forge] orderBy.${nearToEntry.field}.nearTo for vector fields requires a vector array.`,
            );
          }
          if (!dialect.vectorDistanceExpr) {
            throw new Error(
              `[forge] dialect '${dialect.name}' does not implement vectorDistanceExpr`,
            );
          }
          ...
          if (!dialect.geoDistanceExpr) {
            throw new Error(
              `[forge] dialect '${dialect.name}' does not implement geoDistanceExpr`,
            );
          }
          ...
          throw new Error(
            `[forge] orderBy.${nearToEntry.field}.nearTo requires a geoPoint or vector field.`,
          );
        }
      }
      const whereParts = [];
    ...
    function compileCount(
      ...
      const distinctClause = node.distinct?.length
        ? `COUNT(DISTINCT (${node.distinct.map((f3) => `${table}.${dialect.quoteIdent(f3)}`).join(", ")}))`
        : "COUNT(*)";
      const sql = [
    ...
    function compileInsert(
      ...
      const returning =
        node.returning?.exclusive && node.returning.fields.length
          ? ` RETURNING ${node.returning.fields.map((f3) => dialect.quoteIdent(f3)).join(", ")}`
          : " RETURNING *";
    ...
    function compileUpdate(
      ...
      const buildSet = () => {
        ...
        if (node.increment) {
          for (const [k, v2] of Object.entries(node.increment)) {
            parts.push(
              `${dialect.quoteIdent(k)} = ${table}.${dialect.quoteIdent(k)} + ${dialect.placeholder(params, v2)}`,
            );
          }
        }
        if (node.multiply) {
        ...
        if (node.push) {
          for (const [k, v2] of Object.entries(node.push)) {
            parts.push(
              `${dialect.quoteIdent(k)} = array_append(${table}.${dialect.quoteIdent(k)}, ${dialect.placeholder(params, v2)})`,
            );
          }
        }
        if (node.unset?.length) {
      ...
      if (node.upsertCreate) {
        ...
        const colList = cols.map((c) => dialect.quoteIdent(c)).join(", ");
        const valList = cols
          .map((c) => dialect.placeholder(params, node.upsertCreate[c]))
          .join(", ");
        const setParts2 = buildSet();
        const conflictCols = whereLeafColumns(node.where).map((c) =>
          dialect.quoteIdent(c),
        );
        const conflictClause = conflictCols.length
          ? dialect.upsertConflictClause(conflictCols, setParts2.join(", "))
    ...
    function compileGroupBy(
      ...
      const pushAgg = (bucket, field, fn) => {
        const colExpr =
          field === "_all" ? "*" : `${table}.${dialect.quoteIdent(field)}`;
        const alias = `__agg_${bucket.slice(1)}_${field}`;
        aggSelect.push(`${fn}(${colExpr}) AS ${dialect.quoteIdent(alias)}`);
      };
      if (node._count) {
        for (const [k, v2] of Object.entries(node._count))
          if (v2) pushAgg("_count", k, "COUNT");
      }
      if (node._avg) {
        for (const [k, v2] of Object.entries(node._avg))
          if (v2) pushAgg("_avg", k, "AVG");
      }
      if (node._sum) {
        for (const [k, v2] of Object.entries(node._sum))
          if (v2) pushAgg("_sum", k, "SUM");
      }
      if (node._min) {
        for (const [k, v2] of Object.entries(node._min))
          if (v2) pushAgg("_min", k, "MIN");
      }
      if (node._max) {
        for (const [k, v2] of Object.entries(node._max))
          if (v2) pushAgg("_max", k, "MAX");
      }
      const selectList = [...byCols, ...aggSelect].join(", ");
      const where = compileWhere(ctx, node.where);
      const groupByClause = node.by.length
        ...
        for (const [bucket, inner] of Object.entries(node.having)) {
          ...
          for (const [field, opObj] of Object.entries(inner)) {
            ...
            for (const [op, val] of Object.entries(opObj)) {
              ...
              if (!cmp) continue;
              havingParts.push(
                `${fnName}(${colExpr}) ${cmp} ${dialect.placeholder(params, val)}`,
              );
            }
          }
        }
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/dialect.js"(
    ...
    exports.MysqlDialect = {
      ...
      quoteIdent(name) {
        if (/[`\0]/.test(name)) {
          throw new Error(
            `[forge:mysql] invalid identifier: ${JSON.stringify(name)}`,
          );
        }
        return "`" + name + "`";
      },
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/compile-from-ir.js"(
    ...
    function coerceParams(params) {
      return params.map((v2) => {
        ...
        if (
          Array.isArray(v2) ||
          (typeof v2 === "object" && v2 !== null && !(v2 instanceof Date))
        ) {
          return JSON.stringify(v2);
        }
        return v2;
    ...
    function post(a2) {
      return {
        ...
        dialect: "mysql",
        sql: a2.sql,
        params: coerceParams(a2.params),
      };
    }
    function compileSelect(node, modelOverride) {
      const a2 = (0, compile_from_ir_1.compileSelect)(
        node,
        modelOverride,
        dialect_1.MysqlDialect,
      );
      const sql = a2.sql.replace(
        /^SELECT DISTINCT ON \([^)]+\) /,
        "SELECT DISTINCT ",
      );
      return post({ ...a2, sql });
    ...
    function compileInsert(node, modelOverride) {
      const a2 = (0, compile_from_ir_1.compileInsert)(
        node,
        modelOverride,
        dialect_1.MysqlDialect,
      );
    ...
    function compileUpdate(node, modelOverride) {
      let a2 = (0, compile_from_ir_1.compileUpdate)(
        node,
        modelOverride,
        dialect_1.MysqlDialect,
      );
      ...
      if (node.upsertCreate && sql.includes("ON DUPLICATE KEY UPDATE")) {
        ...
        if (m2) {
          ...
          sql = sql.replace(
            ...
            `ON DUPLICATE KEY UPDATE ${rewritten}`,
          );
    ...
    function compileDelete(node, modelOverride) {
      const a2 = (0, compile_from_ir_1.compileDelete)(
        node,
        modelOverride,
        dialect_1.MysqlDialect,
      );
    ...
    function compileGroupBy(node, modelOverride) {
      return post(
        (0, compile_from_ir_1.compileGroupBy)(
          node,
          modelOverride,
          dialect_1.MysqlDialect,
        ),
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/compile.js"(
    ...
    function buildMysqlCompileApi(model3) {
      ...
      return {
        ...
        create: (args) =>
          (0, compile_from_ir_1.compileInsert)(
            (0, build_1.buildInsert)(mk, model3, {
              rows: [args.data],
              returning: args,
            }),
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/sqlite/dialect.js"(
    ...
    exports.SqliteDialect = {
      ...
      quoteIdent(name) {
        if (/["\0]/.test(name)) {
          throw new Error(
            `[forge:sqlite] invalid identifier: ${JSON.stringify(name)}`,
          );
        }
        return `"${name}"`;
      },
...
var require_compile_from_ir4 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/sqlite/compile-from-ir.js"(
    ...
    function compileCount(node, modelOverride) {
      const a2 = (0, compile_from_ir_1.compileCount)(
        node,
        modelOverride,
        dialect_1.SqliteDialect,
      );
      ...
      if (node.distinct && node.distinct.length > 1) {
        ...
        const cols = node.distinct
          .map((f3) => `${table}.${dialect_1.SqliteDialect.quoteIdent(f3)}`)
          .join(", ");
        const wherePart = sql.split("WHERE")[1]
          ? "WHERE" + sql.split("WHERE").slice(1).join("WHERE")
          : "";
    ...
    function compileUpdate(node, modelOverride) {
      const a2 = (0, compile_from_ir_1.compileUpdate)(
        node,
        modelOverride,
        dialect_1.SqliteDialect,
      );
      let sql = a2.sql.replace(
        /ctid = \(SELECT ctid FROM/g,
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/duckdb/dialect.js"(
    ...
    exports.DuckdbDialect = {
      ...
      quoteIdent(name) {
        if (/["\0]/.test(name)) {
          throw new Error(
            `[forge:duckdb] invalid identifier: ${JSON.stringify(name)}`,
          );
        }
        return `"${name}"`;
      },
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/dialect.js"(
    ...
    exports.MssqlDialect = {
      ...
      quoteIdent(name) {
        if (/[\]\0]/.test(name)) {
          throw new Error(
            `[forge:mssql] invalid identifier: ${JSON.stringify(name)}`,
          );
        }
        return `[${name}]`;
      },
...
var require_compile_from_ir6 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/compile-from-ir.js"(
    ...
    function primaryKeyOf(model3) {
      for (const [name, fdef] of Object.entries(model3.fields)) {
        if (fdef?.kind === "id") return name;
      }
      return "id";
    }
    function coerceParams(params) {
      return params.map((v2) => {
        if (v2 === true || v2 === false) return v2 ? 1 : 0;
        if (
          Array.isArray(v2) ||
          (typeof v2 === "object" && v2 !== null && !(v2 instanceof Date))
        ) {
    ...
    function rewriteLimitOffset(sql) {
      ...
      if (limit !== void 0) tail += ` FETCH NEXT ${limit} ROWS ONLY`;
    ...
    function compileGroupBy(node, modelOverride) {
      const a2 = (0, compile_from_ir_1.compileGroupBy)(
        node,
        modelOverride,
        dialect_1.MssqlDialect,
      );
    ...
    function compileMergeUpsert(node, m2) {
      ...
      if (insertCols.length === 0) {
        throw new Error(
          "[forge:mssql] upsert requires at least one field in create.",
        );
      }
      const updateParts = [];
      if (node.set) {
      ...
      if (conflictCols.length === 0) {
        throw new Error(
          `[forge:mssql] upsert requires a conflict target. Use { where: { uniqueCol: value } } (or AND of eq leaves) so the MERGE knows which key identifies an existing row.`,
        );
      }
      ...
      for (const c of conflictCols) {
        if (!insertCols.includes(c)) {
          ...
          if (v2 === void 0) {
            throw new Error(
              `[forge:mssql] upsert conflict column '${c}' is in the where clause but not in create. Add it to create so MERGE can route it to the INSERT branch.`,
            );
          }
          insertCols.push(c);
        }
...
var require_compile6 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/compile.js"(
    ...
    function requireSoftDeleteField(model3, op) {
      ...
      if (!sd) {
        throw new Error(
          `[forge] compile.${op}() requires a field declared with .softDeleteAt() on model '${model3.collection}'.`,
        );
      }
      return sd;
    }
    function buildMssqlCompileApi(model3) {
      ...
      const upsertUnsupported = () => {
        throw new Error(
          `[forge:mssql] upsert / ON CONFLICT is not implemented in 2.3. The T-SQL equivalent (MERGE) lands in v2.4. Until then, use findFirst \u2192 update / create.`,
        );
      };
      return {
        findFirst: (args) =>
...
var require_cascade = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/cascade.js"(
    ...
    async function applyCascadesForDelete(
      parentModel,
      parentDocs,
      ctx = { visited: /* @__PURE__ */ new Set() },
    ) {
      ...
      for (const { childModel, rel: rel3 } of children) {
        ...
        const parentRefValues = unique(
          parentDocs
            .map(
              (p2) =>
                p2[rel3.refs] ?? p2[rel3.refs === "id" ? "_id" : rel3.refs],
            )
            .filter(notNull),
        );
        ...
        const inValues = isObjectIdField
          ? parentRefValues.map((v2) =>
              v2 instanceof (0, bson_1.mongo)().ObjectId
                ? v2
                : typeof v2 === "string" &&
                    (0, bson_1.mongo)().ObjectId.isValid(v2)
                  ? new ((0, bson_1.mongo)().ObjectId)(v2)
                  : v2,
            )
          : parentRefValues;
        const childCollection = client_1.dbClient.db.collection(
          childModel.collection,
        );
        const filter = { [rel3.on]: { $in: inValues } };
        if (onDelete === "SetNull") {
          await childCollection.updateMany(filter, {
            $unset: { [rel3.on]: "" },
          });
          continue;
        }
...
var require_execute = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/execute.js"(
    ...
    async function executeSelect(node, model3, opts = {}) {
      ...
      if (artifact.op === "findOne") {
        let cursor = coll.find(
          filter,
          opts.session ? { session: opts.session } : void 0,
        );
    ...
    async function executeSelectWithGeoNear(node, model3, nearToEntry, opts) {
      ...
      const filter = rewriteNearForGeoNear(
        artifact.args.filter ?? {},
        nearToEntry.field,
      );
    ...
    async function applyProjectionAndHydration(rows, model3, node, session) {
      ...
      if (node.projection?.counts?.length) {
        await applyRelationCounts(
          rows,
          model3,
          node.projection.counts,
          session,
        );
      }
    ...
    async function executeDelete(node, model3, opts = {}) {
      ...
      if (artifact.op === "findOneAndDelete") {
        ...
        if (!target) return { doc: void 0, count: 0 };
    ...
    async function executeGroupBy(node, model3, opts = {}) {
      ...
      const docs = await coll
        .aggregate(artifact.args.pipeline, sessOpt)
        .toArray();
    ...
    async function hydrateOwningOne(
      ...
      if (fks.length === 0) {
        for (const r of rows) r[rel3.name] = null;
        return;
      }
      const coercedRefs = fks.map((v2) =>
        (0, coerce_1.coerceFieldValue)(
          (0, coerce_1.getFieldDef)(targetModel, rel3.refs) ??
            targetModel.fields.id,
          v2,
        ),
      );
      ...
      for (const t of found) byRef.set(stringKey(t[rel3.refs]), t);
      for (const r of rows) {
        const k = r[rel3.on];
    ...
    async function hydrateInverseOne(
      ...
      const coerced = parentRefs.map((v2) =>
        (0, coerce_1.coerceFieldValue)(
          fkDef ?? targetModel.fields[rel3.on] ?? { kind: "objectId" },
          v2,
        ),
      );
      ...
      for (const t of found) byFk.set(stringKey(t[rel3.on]), t);
      for (const r of rows) {
        const k = r[rel3.refs];
    ...
    async function hydrateMany(rows, rel3, parentModel, targetModel, session) {
      const parentRefs = unique(rows.map((r) => r[rel3.refs]).filter(notNull));
      if (parentRefs.length === 0) {
        for (const r of rows) r[rel3.name] = [];
        return;
      }
      const fkDef = (0, coerce_1.getFieldDef)(targetModel, rel3.on);
      const coerced = parentRefs.map((v2) =>
      ...
      const where = subNode.where
        ? { kind: "and", children: [subNode.where, fkLeaf] }
        : fkLeaf;
      const node = {
        ...subNode,
        kind: "select",
        ...
        const grouped = await coll
          .aggregate(
            [
              {
                $match: {
                  [(0, coerce_1.appKeyToDbKey)(rel3.on)]: { $in: coerced },
                },
              },
              {
                $group: {
                  _id: `$${(0, coerce_1.appKeyToDbKey)(rel3.on)}`,
                  c: { $sum: 1 },
                },
              },
            ],
    ...
    function stringKey(v2) {
      if (v2 == null) return "\0";
      if (v2 instanceof (0, bson_1.mongo)().ObjectId) return v2.toHexString();
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/adapter.js"(
    ...
    var MongoAdapter = class {
      ...
      async connect(url) {
        this._url = url;
        if (this._injected) {
          await client_1.dbClient.adopt(
            this._injected.client,
            this._injected.dbName,
          );
          return;
        }
      ...
      executeSelect(node, model3, opts) {
        return this._track(
          ...
          node,
          () =>
            (0, execute_1.executeSelect)(node, model3, this.mongoOpts(opts)),
          (r) => r.length,
        );
      }
      executeCount(node, model3, opts) {
        return this._track(
          "count",
          node,
          () => (0, execute_1.executeCount)(node, model3, this.mongoOpts(opts)),
          () => 1,
        );
      }
      executeInsert(node, model3, opts) {
        return this._track(
          ...
          node,
          () =>
            (0, execute_1.executeInsert)(node, model3, this.mongoOpts(opts)),
          (r) => r.count,
        );
      }
      executeUpdate(node, model3, opts) {
        return this._track(
          ...
          node,
          () =>
            (0, execute_1.executeUpdate)(node, model3, this.mongoOpts(opts)),
          (r) => r.count,
          opts?.semanticOp,
        );
      }
      executeDelete(node, model3, opts) {
        return this._track(
          ...
          node,
          () =>
            (0, execute_1.executeDelete)(node, model3, this.mongoOpts(opts)),
          (r) => r.count,
        );
      }
      executeGroupBy(node, model3, opts) {
        return this._track(
          ...
          node,
          () =>
            (0, execute_1.executeGroupBy)(node, model3, this.mongoOpts(opts)),
          (r) => r.length,
        );
      }
      ...
      async *streamSelect(node, model3, opts) {
        const { compileSelect } = await Promise.resolve().then(() =>
          __importStar(require_compile_from_ir()),
        );
      ...
      applyProjectionAndHydration(rows, model3, node, opts) {
        return (0, execute_1.applyProjectionAndHydration)(
          rows,
          model3,
          node,
          opts?.session,
      ...
      async refreshView(model3, _opts) {
        ...
        if (!source) {
          throw new Error(
            `[forge:mongo] materialised view '${model3?.collection}' needs a sourceCollection to refresh`,
          );
        }
        const hasOutStage = pipeline.some((s) => s && (s.$merge || s.$out));
        const full = hasOutStage
          ? pipeline
          : [...pipeline, { $out: model3.collection }];
      ...
      async introspect() {
        ...
        for (const c of colls) {
          ...
          const idxs = await client_1.dbClient.db
            .collection(c.name)
            .indexes()
            .catch(() => []);
          tables.push({
      ...
      $queryRaw(_fragment, _opts) {
        return Promise.reject(
          new Error(
            "[forge] $queryRaw is SQL-only. For Mongo, use db.<model>.aggregate({ pipeline }) or db.$runCommandRaw(command).",
          ),
        );
      }
...
var require_collection = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/builder/collection.js"(
    ...
    var randomUUID = () => {
      ...
      if (c?.getRandomValues) {
        ...
        b2[8] = (b2[8] & 63) | 128;
        const h = [...b2]
          .map((x2) => x2.toString(16).padStart(2, "0"))
          .join("");
    ...
    var coerce_1 = require_coerce();
    var errors_1 = require_errors();
    Object.defineProperty(exports, "DbKnownError", {
      enumerable: true,
      get: function () {
    ...
    var CollectionWrapper = class _CollectionWrapper {
      ...
      _allowedWhereKeys() {
        ...
        for (const fieldName of Object.keys(this.model.fields))
          keys.add(fieldName);
        for (const rel3 of Object.keys(this.model.relations())) keys.add(rel3);
  ...
  (strict mode is on \u2014 disable with createDb({ strict: false }) to allow loose keys.)`);
      ...
      get compile() {
        if (!this._compileApi) {
          ...
          switch (kind) {
            case "postgres":
              this._compileApi = (0, compile_2.buildPostgresCompileApi)(
                this.model,
              );
              break;
            case "mysql":
              this._compileApi = (0, compile_3.buildMysqlCompileApi)(
                this.model,
              );
              break;
            case "sqlite":
              this._compileApi = (0, compile_4.buildSqliteCompileApi)(
                this.model,
              );
              break;
            case "duckdb":
              this._compileApi = (0, compile_5.buildDuckdbCompileApi)(
                this.model,
              );
              break;
            case "mssql":
              this._compileApi = (0, compile_6.buildMssqlCompileApi)(
                this.model,
              );
              break;
            case "indexeddb":
              throw new Error(
                "[forge] .compile is not implemented for the IndexedDB adapter yet (no SQL or aggregation pipeline shape \u2014 IDB is native). Use the model methods (findMany, create, \u2026) directly.",
              );
            case "mongo":
            default:
              this._compileApi = (0, compile_1.buildMongoCompileApi)(
                this.model,
              );
              break;
          }
      ...
      get compileMongo() {
        ...
        if (kind !== "mongo") {
          throw new Error(
            `[forge] .compileMongo is only available on a Mongo adapter (current adapter: ${kind}). Use .compile or .compileSql instead.`,
          );
        }
        return this.compile;
      }
      ...
      get compileSql() {
        ...
        if (kind === "mongo") {
          throw new Error(
            `[forge] .compileSql is not available on a Mongo adapter. Use .compile or .compileMongo instead.`,
          );
        }
        return this.compile;
      }
      get collection() {
        if (!this._collection) {
          this._collection = client_1.dbClient.db.collection(
      ...
      async *findManyStream(args = {}) {
        if (typeof this.adapter.streamSelect === "function") {
          ...
          const node = (0, build_1.buildSelect)(
            mk,
            this.model,
            filtered ?? {},
            "many",
          ...
          const iter = this.adapter.streamSelect(node, this.model, {
            session: this._session,
          });
          for await (const row of iter) yield row;
          return;
        }
        const chunkSize = args.chunkSize ?? 1e3;
        let offset = 0;
        while (true) {
          const batch = await this._find(
            { ...args, take: chunkSize, skip: offset, chunkSize: void 0 },
            void 0,
          );
      ...
      async count(args = {}) {
        ...
        const node = (0, build_1.buildCount)(
          mk,
          this.model,
          args,
          schema_1.schema,
        );
        return this.adapter.executeCount(node, this.model, {
          session: this._session,
        });
      }
      ...
      async groupBy(args) {
        const mk = this._modelKey();
        const node = (0, build_1.buildGroupBy)(
          mk,
          this.model,
          args,
          schema_1.schema,
        );
        return this.adapter.executeGroupBy(node, this.model, {
          session: this._session,
        });
      }
  ...
  Use the underlying source model for writes, or drop .asView() from the schema.`);
      ...
      async create(args) {
        ...
        const resolvedScalar = await this._resolveOwningConnectOrCreate(
          scalar,
          nested,
        );
        const row = this.adapter.coerceInbound(
          this.model,
          this._fillAutoId(resolvedScalar),
        );
        const node = (0, build_1.buildInsert)(
          mk,
          this.model,
          { rows: [row] },
          schema_1.schema,
        );
        const { docs } = await this.adapter.executeInsert(node, this.model, {
          session: this._session,
        });
        const doc = docs[0];
      ...
      async _resolveOwningConnectOrCreate(scalar, nested) {
        ...
        for (let i = nested.length - 1; i >= 0; i--) {
          ...
          if (!target) continue;
          const w = new _CollectionWrapper(
            target,
            this._session,
            this._adapter,
            this._strict,
          ...
          const it2 = items[0];
          if (!it2?.where) continue;
          let existing = await w.findFirst({ where: it2.where });
          if (!existing) existing = await w.create({ data: it2.create ?? {} });
      ...
      async createMany(args) {
        ...
        const mk = this._modelKey();
        const rows = args.data.map((d2) =>
          this.adapter.coerceInbound(this.model, this._fillAutoId(d2)),
        );
        const node = (0, build_1.buildInsert)(
          mk,
          this.model,
        ...
        const { count } = await this.adapter.executeInsert(node, this.model, {
          session: this._session,
        });
        return { count };
      }
      async update(args, _internal) {
        ...
        const node = (0, build_1.buildUpdate)(
          mk,
          this.model,
          {
            where: args.where,
      ...
      async upsert(args) {
        ...
        this._assertStrictWhere(args.where);
        const mk = this._modelKey();
        const createCoerced = this.adapter.coerceInbound(
          this.model,
          this._fillAutoId(args.create),
        );
        const node = (0, build_1.buildUpdate)(
          mk,
          this.model,
          {
            where: args.where,
            data: this._applyUpdatedAt(args.update),
            many: false,
            upsertCreate: createCoerced,
          },
          schema_1.schema,
        );
        const { doc } = await this.adapter.executeUpdate(node, this.model, {
      ...
      async delete(args) {
        ...
        this._assertStrictWhere(args.where);
        const mk = this._modelKey();
        const node = (0, build_1.buildDelete)(
          mk,
          this.model,
          { where: args.where, many: false },
          schema_1.schema,
        );
        const { doc } = await this.adapter.executeDelete(node, this.model, {
          session: this._session,
        });
        if (!doc)
          throw (0, errors_1.notFoundError)(this.model.collection, args.where);
      ...
      async deleteMany(args = {}) {
        ...
        const r = await this.adapter.executeDelete(node, this.model, {
          session: this._session,
        });
        return { count: r.count };
      }
      ...
      async softDelete(args) {
        ...
        return this.update(
          { ...args, data: { [sd]: /* @__PURE__ */ new Date() } },
      ...
      async softDeleteMany(args = {}) {
        ...
        return this.updateMany(
          { where: args.where, data: { [sd]: /* @__PURE__ */ new Date() } },
      ...
      async refresh(opts = {}) {
        ...
        if (!view?.materialised) {
          throw new Error(
            `[forge] refresh() is only valid on a materialised view. '${this.model.collection}' is ${view ? "a plain view" : "a table"}. Declare it with .asView({ materialised: true, ... }).`,
          );
        }
        if (typeof this.adapter.refreshView !== "function") {
          throw new Error(
            `[forge] adapter '${this.adapter.kind}' does not implement materialised-view refresh.`,
          );
        }
        await this.adapter.refreshView(this.model, {
          ...opts,
          session: this._session,
        });
      }
      ...
      scheduleRefresh(every) {
        ...
        if (!ms2)
          throw new Error(
            `[forge] scheduleRefresh needs a duration like '30s' / '5m' / '1h' (got ${JSON.stringify(spec)})`,
          );
      ...
      _softDeleteField() {
        for (const [name, f3] of Object.entries(this.model.fields)) {
          if (f3.softDeleteAt) return name;
        }
        return void 0;
      }
      ...
      _requireSoftDeleteField(op) {
        ...
        if (!sd) {
          throw new Error(
            `[forge] ${op}() requires a field declared with .softDeleteAt() on '${this.model.collection}'. Either add one, or use delete() for a hard delete.`,
          );
        }
        return sd;
      }
      ...
      _withSoftDeleteFilter(args) {
        ...
        if (Object.prototype.hasOwnProperty.call(where, sd)) return args;
      ...
      async _find(args, hardLimit) {
        ...
        if (
          hardLimit != null &&
          (node.limit == null || node.limit > hardLimit)
        ) {
          node.limit = hardLimit;
        }
        const rows = await this.adapter.executeSelect(node, this.model, {
          session: this._session,
        });
        return rows;
      }
      async _returnOne(rawDoc, args) {
        ...
        const rows = [decoded];
        const { projection, hydration } = (0, build_1.buildProjection)(
          this.model,
          args,
          schema_1.schema,
        );
        ...
        if (projection?.exclusive && projection.fields.length) {
          ...
          for (const k of Object.keys(rows[0]))
            if (kept.has(k)) pruned[k] = rows[0][k];
          return pruned;
        }
        ...
        for (const key of Object.keys(data)) {
          ...
          if (rel3.kind === "one" && !rel3.inverse) {
            ...
            if ("connect" in value && value.connect) {
              ...
              if (fk !== void 0) scalar[rel3.on] = fk;
            } else if ("connectOrCreate" in value && value.connectOrCreate) {
              nested.push({
                rel: rel3,
                op: "connectOrCreate",
                data: value.connectOrCreate,
              });
          ...
          if (value.set) nested.push({ rel: rel3, op: "set", data: value.set });
          if (value.delete)
      ...
      async _applyNestedWrites(parentDoc, nested) {
        for (const spec of nested) {
          ...
          if (!target) {
            throw new Error(
              `[Database] nested write target '${rel3.target}' is not in the schema map`,
            );
          }
          const targetWrapper = new _CollectionWrapper(
            target,
            this._session,
            this._adapter,
            this._strict,
          ...
          if (op === "create") {
            ...
            for (const d2 of item) {
              await targetWrapper.create({
                data: { ...d2, [childFkField]: fkValue },
              });
            }
            continue;
          }
          ...
          if (op === "connectOrCreate") {
            ...
            for (const it2 of items) {
              if (!it2?.where) continue;
              let existing = await targetWrapper.findFirst({
                where: it2.where,
              });
              if (!existing) {
                const createData = rel3.inverse
                  ? { ...(it2.create ?? {}), [childFkField]: fkValue }
                  : (it2.create ?? {});
    ...
    function parseDuration(spec) {
      if (!spec || typeof spec !== "string") return void 0;
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/postgres/errors.js"(
    ...
    var MAP = {
      ...
      23505: {
        code: "P2002",
        message: (e) =>
          `Unique constraint failed${e.constraint ? ` on ${e.constraint}` : ""}`,
      },
      23503: {
        code: "P2003",
        message: (e) =>
          `Foreign key constraint failed${e.constraint ? ` on ${e.constraint}` : ""}`,
      },
      23502: {
        code: "P2011",
        message: (e) =>
          `Null constraint violation on ${e.column ?? "(unknown column)"}`,
      },
      23514: {
        code: "P2004",
        message: (e) =>
          `Check constraint failed${e.constraint ? ` on ${e.constraint}` : ""}`,
      },
      // 42xxx — schema / syntax
      "42P01": {
        code: "P2021",
        message: (e) => `Table does not exist: ${e.table ?? "(unknown)"}`,
      },
      42703: {
        code: "P2022",
        message: (e) => `Column does not exist: ${e.column ?? "(unknown)"}`,
      },
      "42P02": {
        code: "P2022",
        message: (e) => `Parameter does not exist: ${e.message ?? ""}`,
      },
      // 40xxx — transaction
      "40P01": {
        code: "P2034",
        message: () => "Transaction deadlock \u2014 please retry",
      },
      40001: {
        code: "P2034",
      ...
      "08000": {
        code: "P1001",
        message: (e) => `Connection error: ${e.message ?? ""}`,
      },
      "08006": {
        code: "P1001",
        message: (e) => `Connection failure: ${e.message ?? ""}`,
      },
      // 28xxx — auth
      "28P01": {
        code: "P1010",
        message: () => "Authentication failed for database user",
      },
      28000: {
        code: "P1010",
    ...
    function rethrowPgError(err) {
      ...
      if (!mapping) {
        if (err instanceof errors_1.DbKnownError) throw err;
        throw err;
      }
      const meta = { sqlstate };
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/shared/haversine.js"(
    ...
    function pointInRing(point, ring) {
      ...
      for (let i = 0, j = ring.length - 1; i < ring.length; j = i++) {
        const xi2 = ring[i].lng,
          yi2 = ring[i].lat;
        const xj = ring[j].lng,
          yj = ring[j].lat;
        const intersects =
          yi2 > y !== yj > y &&
          x2 < ((xj - xi2) * (y - yi2)) / (yj - yi2) + xi2;
    ...
    function extractFallbackGeoOps(node, model3) {
      ...
      walkWhere(node.where, (leaf) => {
        ...
        if (leaf.op === "near") {
          ...
          near = {
            field: leaf.field,
            point: { lng: v2.lng, lat: v2.lat },
            withinMeters: v2.withinMeters,
          };
      ...
      if (nt2) {
        ...
        if (
          ...
          fld.geo?.fallback &&
          ntVal &&
          typeof ntVal.lng === "number" &&
          typeof ntVal.lat === "number"
        ) {
          nearTo = {
            field: nt2.field,
            point: { lng: ntVal.lng, lat: ntVal.lat },
          };
        }
      }
    ...
    function applyHaversinePostFilter(rows, filter, orderBy, polygon = null) {
      ...
      for (const row of rows) {
        ...
        if (ref) {
          ...
          if (filter && radius !== void 0 && d2 > radius) continue;
          if (orderBy) row._distanceMeters = d2;
        }
        out.push(row);
      }
      if (orderBy) {
...
var require_execute2 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/postgres/execute.js"(
    ...
    async function executePgSelect(pool, node, model3, opts = {}) {
      ...
      const artifact = (0, compile_from_ir_1.compileSelect)(node, model3);
      const { rows } = await (0, errors_1.withPgErrors)(() =>
        exec.query(artifact.sql, artifact.params),
      );
      let out = rows;
      if (node.distinct?.length) out = dedupeBy(out, node.distinct);
      const { extractFallbackGeoOps, applyHaversinePostFilter } =
        await Promise.resolve().then(() => __importStar(require_haversine()));
      const ops = extractFallbackGeoOps(node, model3);
      if (ops.near || ops.nearTo || ops.withinPolygon) {
        out = applyHaversinePostFilter(
          out,
          ops.near,
          ops.nearTo,
          ops.withinPolygon,
    ...
    async function executePgInsert(pool, node, model3, opts = {}) {
      const exec = opts.client ?? pool;
      const artifact = (0, compile_from_ir_1.compileInsert)(node, model3);
      const { rows, rowCount } = await (0, errors_1.withPgErrors)(() =>
        exec.query(artifact.sql, artifact.params),
      );
    ...
    async function hydrate(exec, rows, parentModel, hydration) {
      ...
      for (const rel3 of hydration) {
        ...
        if (!targetModel) continue;
        const isOwningOne =
          rel3.kind === "one" && parentModel.fields[rel3.on] != null;
        if (isOwningOne) await hydrateOwningOne(exec, rows, rel3, targetModel);
        else if (rel3.kind === "one")
          await hydrateInverseOne(exec, rows, rel3, targetModel);
        else await hydrateMany(exec, rows, rel3, targetModel);
      }
    }
    ...
    async function hydrateMany(exec, rows, rel3, targetModel) {
      ...
      const where = nestedWhere
        ? { kind: "and", children: [nestedWhere, fkLeaf] }
        : fkLeaf;
      const subNode = {
        kind: "select",
        model: rel3.target,
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/postgres/driver.js"(
        ...
        transaction: async (fn) => {
          ...
          try {
            ...
            const result = await fn({
              query: async (s, p2) => norm(await client.query(s, p2)),
            });
    ...
    function postgresJsDriver(sql) {
      ...
      return {
        ...
        transaction: (fn) =>
          sql.begin((txSql) =>
            fn({ query: (text, params) => run(txSql, text, params) }),
          ),
        close: async () => {
    ...
    function isPostgresDriver(v2) {
      return (
        ...
        typeof v2 === "object" &&
        v2.kind === "postgres" &&
        typeof v2.query === "function" &&
        typeof v2.transaction === "function"
      );
    }
  },
});
...
var require_introspect = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/postgres/introspect.js"(
    ...
    async function introspectPg(pool) {
      const cols =
        await pool.query(`SELECT table_name, column_name, data_type, udt_name, is_nullable,
      ...
      const fks =
        await pool.query(`SELECT con.conname AS name, t.relname AS table_name,
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/raw-sql.js"(
    ...
    exports.forgeSql = {
      ...
      join(parts, separator = ", ") {
        if (parts.length === 0) return exports.forgeSql.empty;
        const strings = [];
        const values = [];
        for (let i = 0; i < parts.length; i++) {
          const p2 = parts[i];
          if (i === 0) strings.push(p2.strings[0]);
          else strings[strings.length - 1] += separator + p2.strings[0];
    ...
    var PostgresAdapter = class {
      ...
      async doctor() {
        ...
        const driver = injected
          ? { installed: true, version: void 0 }
          : (0, missing_driver_1.isDriverInstalled)("postgres");
        return {
          kind: "postgres",
      ...
      get driver() {
        if (!this._driver)
          throw new Error(
            "[forge:postgres] driver accessed before connect() resolved",
          );
        return this._driver;
      }
      ...
      async _track(op, node, model3, exec, countRows, semanticOp) {
        ...
        const {
          ...
          __importStar(require_compile_from_ir2()),
        );
        const artifact =
          op === "select"
            ? compileSelect(node, model3)
            : op === "count"
              ? compileCount(node, model3)
              : op === "groupBy"
                ? compileGroupBy(node, model3)
                : op === "insert"
                  ? compileInsert(node, model3)
                  : op === "update"
                    ? compileUpdate(node, model3)
                    : compileDelete(node, model3);
        return this.emitter.track(
          {
            adapter: "postgres",
            model: node.model ?? "",
      ...
      async refreshView(model3, opts) {
        ...
        await this.handle(opts).query(
          `REFRESH MATERIALIZED VIEW ${concurrently}${q}`,
          [],
        );
      }
      async introspect() {
        const { introspectPg } = await Promise.resolve().then(() =>
          __importStar(require_introspect()),
        );
        return introspectPg(this.driver);
      }
      async $queryRaw(fragment, opts) {
        const { compileSqlFragment } = await Promise.resolve().then(() =>
          __importStar(require_raw_sql()),
        );
        const { sql, params } = compileSqlFragment(fragment, "postgres");
        const { withPgErrors } = await Promise.resolve().then(() =>
          __importStar(require_errors2()),
        );
        const { rows } = await withPgErrors(() =>
          this.handle(opts).query(sql, params),
        );
        return rows;
      }
      async $executeRaw(fragment, opts) {
        ...
        const { rowCount } = await withPgErrors(() =>
          this.handle(opts).query(sql, params),
        );
        return rowCount ?? 0;
      }
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/errors.js"(
    ...
    var MAP = {
      1062: {
        code: "P2002",
        mk: (e) =>
          `Unique constraint failed: ${e.sqlMessage ?? e.message ?? ""}`,
      },
      // ER_DUP_ENTRY
      1452: {
        code: "P2003",
        mk: (e) =>
          `Foreign key constraint failed: ${e.sqlMessage ?? e.message ?? ""}`,
      },
      // ER_NO_REFERENCED_ROW_2
      1451: {
        code: "P2003",
        mk: (e) =>
          `Foreign key constraint failed (delete blocked): ${e.sqlMessage ?? ""}`,
      },
      // ER_ROW_IS_REFERENCED_2
      1048: {
        code: "P2011",
        mk: (e) => `Null constraint violation: ${e.sqlMessage ?? ""}`,
      },
      // ER_BAD_NULL_ERROR
      3819: {
        code: "P2004",
        mk: (e) => `Check constraint failed: ${e.sqlMessage ?? ""}`,
      },
      // ER_CHECK_CONSTRAINT_VIOLATED
      1146: {
        code: "P2021",
        mk: (e) => `Table does not exist: ${e.sqlMessage ?? ""}`,
      },
      // ER_NO_SUCH_TABLE
      1054: {
        code: "P2022",
        mk: (e) => `Column does not exist: ${e.sqlMessage ?? ""}`,
      },
      // ER_BAD_FIELD_ERROR
      1213: {
        code: "P2034",
        mk: () => "Transaction deadlock \u2014 please retry",
      },
      // ER_LOCK_DEADLOCK
      1205: {
        code: "P2034",
        mk: () => "Lock wait timeout \u2014 please retry",
      },
      ...
      1045: {
        code: "P1010",
        mk: () => "Access denied \u2014 authentication failed",
      },
...
var require_execute3 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/execute.js"(
    ...
    async function executeMysqlSelect(pool, node, model3, opts = {}) {
      ...
      const [rows] = await (0, errors_1.withMysqlErrors)(() =>
        exec.query(a2.sql, a2.params),
      );
    ...
    async function executeMysqlInsert(pool, node, model3, opts = {}) {
      ...
      const [result] = await (0, errors_1.withMysqlErrors)(() =>
        exec.execute(a2.sql, a2.params),
      );
      const ids = node.rows.map((r) => r.id).filter((id) => id != null);
      if (ids.length === 0) {
        if (result.insertId != null && result.affectedRows > 0) {
          const placeholders2 = Array.from(
          ...
          const [docs2] = await (0, errors_1.withMysqlErrors)(() =>
            exec.query(
              `SELECT * FROM \`${model3.collection}\` WHERE \`id\` IN (${placeholders2})`,
              ranged,
            ),
          );
          return {
            docs: docs2.map((r) => decodeRow(model3, r)),
      ...
      const [docs] = await (0, errors_1.withMysqlErrors)(() =>
        exec.query(
          `SELECT * FROM \`${model3.collection}\` WHERE \`id\` IN (${placeholders})`,
          ids,
        ),
      );
      return {
        docs: docs.map((r) => decodeRow(model3, r)),
        count: result.affectedRows,
      };
    }
    async function executeMysqlUpdate(pool, node, model3, opts = {}) {
      ...
      if (whereHasNonEq(node.where) && result.affectedRows === 0)
        return { doc: void 0, count: 0 };
      const selectArtifact = (0, compile_from_ir_1.compileSelect)(
        (0, build_1.buildSelect)(
          node.model,
          model3,
          { where: irWhereToObject(node.where), take: 1 },
          "one",
        ),
        model3,
      );
      const [rows] = await (0, errors_1.withMysqlErrors)(() =>
        exec.query(selectArtifact.sql, selectArtifact.params),
      );
      const doc = rows[0];
      return {
        doc: doc ? decodeRow(model3, doc) : void 0,
        count: result.affectedRows,
      };
    }
    async function executeMysqlDelete(pool, node, model3, opts = {}) {
      ...
      if (node.many) {
        ...
        const [result2] = await (0, errors_1.withMysqlErrors)(() =>
          exec.execute(a3.sql, a3.params),
        );
      ...
      const doc = rows[0];
      if (!doc) return { doc: void 0, count: 0 };
    ...
    async function hydrate(pool, opts, rows, parentModel, hydration) {
      ...
      for (const rel3 of hydration) {
        ...
        else await hydrateMany(pool, opts, rows, rel3, targetModel);
      }
    }
    async function hydrateOne(pool, opts, rows, rel3, targetModel, owning) {
      ...
      const fks = unique(
        rows.map((r) => r[fromField]).filter((v2) => v2 != null),
      );
      if (fks.length === 0) {
        for (const r of rows) r[rel3.name] = null;
        return;
    ...
    async function hydrateMany(pool, opts, rows, rel3, targetModel) {
      const refs = unique(
        rows.map((r) => r[rel3.refs]).filter((v2) => v2 != null),
      );
      if (refs.length === 0) {
        for (const r of rows) r[rel3.name] = [];
        return;
    ...
    async function applyRelationCounts(exec, rows, parentModel, counts) {
      ...
      for (const relName of counts) {
        ...
        if (refs.length === 0) {
          for (const r of rows) r._count[relName] = 0;
          continue;
        }
        ...
        const [groups] = await (0, errors_1.withMysqlErrors)(() =>
          exec.query(sql, refs),
        );
        const byFk = /* @__PURE__ */ new Map();
...
var require_driver2 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/driver.js"(
      ...
      const writeTuple = (r) => [
        {
          ...
          insertId: r?.insertId != null ? Number(r.insertId) : void 0,
        },
        void 0,
      ];
      const sess = (conn) => ({
        ...
        execute: async (sql, params) =>
          writeTuple(await conn.query(sql, params)),
      });
      return {
        kind: "mysql",
        query: async (sql, params) => asTuple(await pool.query(sql, params)),
        execute: async (sql, params) =>
          writeTuple(await pool.query(sql, params)),
        transaction: async (fn) => {
          const conn = await pool.getConnection();
          try {
    ...
    function planetscaleDriver(conn) {
      ...
      const writeTuple = (r) => [
        {
          affectedRows: Number(r.rowsAffected ?? 0),
          insertId: r.insertId != null ? Number(r.insertId) : void 0,
        },
        r.fields,
      ];
      const sess = (tx) => ({
        ...
        execute: async (sql, params) =>
          writeTuple(await tx.execute(sql, params)),
      });
      return {
        kind: "mysql",
        query: async (sql, params) =>
          readTuple(await conn.execute(sql, params)),
        execute: async (sql, params) =>
          writeTuple(await conn.execute(sql, params)),
...
var require_introspect2 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/introspect.js"(
    ...
    async function introspectMysql(pool) {
      const [tables] =
        await pool.query(`SELECT TABLE_NAME AS name, TABLE_TYPE AS type
       FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE()`);
      const [cols] =
        await pool.query(`SELECT TABLE_NAME AS t, COLUMN_NAME AS name, COLUMN_TYPE AS type,
      ...
      try {
        const [r] =
          await pool.query(`SELECT TABLE_NAME AS t, INDEX_NAME AS name, NON_UNIQUE AS nonUnique,
      ...
      const [fks] =
        await pool.query(`SELECT CONSTRAINT_NAME AS name, TABLE_NAME AS t, COLUMN_NAME AS col,
            REFERENCED_TABLE_NAME AS refTable, REFERENCED_COLUMN_NAME AS refColumn
       FROM information_schema.KEY_COLUMN_USAGE
      WHERE TABLE_SCHEMA = DATABASE() AND REFERENCED_TABLE_NAME IS NOT NULL`);
      const baseTables = new Set(
        tables.filter((r) => r.type === "BASE TABLE").map((r) => r.name),
      );
      const tableMap = /* @__PURE__ */ new Map();
      const ensure = (name) => {
        let t = tableMap.get(name);
      ...
      return {
        ...
        views: tables
          ...
          .map((r) => ({ name: r.name, materialised: false })),
      };
    }
  },
});
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mysql/adapter.js"(
    ...
    var MysqlAdapter = class {
      ...
      async doctor() {
        ...
        const driver = injected
          ? { installed: true, version: void 0 }
          : (0, missing_driver_1.isDriverInstalled)("mysql");
        return {
          kind: "mysql",
      ...
      get driver() {
        if (!this._driver)
          throw new Error(
            "[forge:mysql] driver accessed before connect() resolved",
          );
        return this._driver;
      }
      ...
      async _track(op, node, model3, exec, countRows, semanticOp) {
        ...
        const c = await Promise.resolve().then(() =>
          __importStar(require_compile_from_ir3()),
        );
        const a2 =
          op === "select"
            ? c.compileSelect(node, model3)
            : op === "count"
              ? c.compileCount(node, model3)
              : op === "groupBy"
                ? c.compileGroupBy(node, model3)
                : op === "insert"
                  ? c.compileInsert(node, model3)
                  : op === "update"
                    ? c.compileUpdate(node, model3)
                    : c.compileDelete(node, model3);
        return this.emitter.track(
          {
            adapter: "mysql",
            model: node.model ?? "",
      ...
      executeSelect(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMysqlSelect)(
              this.handle(opts),
              node,
              model3,
              this.mysqlOpts(opts),
      ...
      executeInsert(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMysqlInsert)(
              this.handle(opts),
              node,
              model3,
              this.mysqlOpts(opts),
      ...
      executeUpdate(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMysqlUpdate)(
              this.handle(opts),
              node,
              model3,
              this.mysqlOpts(opts),
      ...
      executeDelete(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMysqlDelete)(
              this.handle(opts),
              node,
              model3,
              this.mysqlOpts(opts),
      ...
      executeGroupBy(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMysqlGroupBy)(
              this.handle(opts),
              node,
              model3,
              this.mysqlOpts(opts),
      ...
      async refreshView(model3, opts) {
        ...
        if (!sql)
          throw new Error(
            `[forge:mysql] '${model3?.collection}' has no view SQL to refresh`,
          );
        const q = "`" + String(model3.collection).replace(/`/g, "``") + "`";
        const run = async (c) => {
      ...
      async introspect() {
        const { introspectMysql } = await Promise.resolve().then(() =>
          __importStar(require_introspect2()),
        );
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/sqlite/errors.js"(
    ...
    var STRING_MAP = {
      ...
      SQLITE_CONSTRAINT_UNIQUE: {
        code: "P2002",
        mk: (e) => `Unique constraint failed: ${e.message ?? ""}`,
      },
      SQLITE_CONSTRAINT_PRIMARYKEY: {
        code: "P2002",
        mk: (e) => `Primary key constraint failed: ${e.message ?? ""}`,
      },
      SQLITE_CONSTRAINT_FOREIGNKEY: {
        code: "P2003",
        mk: (e) => `Foreign key constraint failed: ${e.message ?? ""}`,
      },
      SQLITE_CONSTRAINT_NOTNULL: {
        code: "P2011",
        mk: (e) => `Null constraint violation: ${e.message ?? ""}`,
      },
      SQLITE_CONSTRAINT_CHECK: {
        code: "P2004",
        mk: (e) => `Check constraint failed: ${e.message ?? ""}`,
      },
      SQLITE_CONSTRAINT_TRIGGER: {
        code: "P2004",
        mk: (e) => `Trigger constraint failed: ${e.message ?? ""}`,
      },
      ...
      SQLITE_BUSY: {
        code: "P2034",
        mk: () => "Database busy \u2014 please retry",
      },
      SQLITE_LOCKED: {
        code: "P2034",
        mk: () => "Database locked \u2014 please retry",
      },
      // i/o / connection
      SQLITE_IOERR: {
        code: "P1001",
        mk: (e) => `IO error: ${e.message ?? ""}`,
      },
      SQLITE_CANTOPEN: {
        code: "P1001",
        mk: (e) => `Cannot open database file: ${e.message ?? ""}`,
      },
    };
    function rethrowSqliteError(err) {
      ...
      for (const k of Object.keys(STRING_MAP)) {
        if (code === k || code.startsWith(k + "_")) {
          ...
          throw new errors_1.DbKnownError(m2.code, m2.mk(err), {
            sqliteCode: code,
            detail: err.message,
          });
        }
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/sqlite/execute.js"(
    ...
    function encodeParams(params) {
      return params.map((v2) => {
        ...
        if (Array.isArray(v2)) return JSON.stringify(v2);
        return v2;
      });
    }
    function isBufferLike(v2) {
      if (v2 instanceof Uint8Array) return true;
    ...
    async function executeSqliteSelect(db, node, model3, opts = {}) {
      ...
      const artifact = (0, compile_from_ir_1.compileSelect)(node, model3);
      const raw = await (0, errors_1.withSqliteErrors)(() =>
        exec.all(artifact.sql, encodeParams(artifact.params)),
      );
    ...
    async function executeSqliteCount(db, node, model3, opts = {}) {
      const exec = opts.db ?? db;
      const artifact = (0, compile_from_ir_1.compileCount)(node, model3);
      const r = await (0, errors_1.withSqliteErrors)(() =>
        exec.get(artifact.sql, encodeParams(artifact.params)),
      );
    ...
    async function executeSqliteGroupBy(db, node, model3, opts = {}) {
      const exec = opts.db ?? db;
      const artifact = (0, compile_from_ir_1.compileGroupBy)(node, model3);
      const rows = await (0, errors_1.withSqliteErrors)(() =>
        exec.all(artifact.sql, encodeParams(artifact.params)),
      );
      return rows.map((r) => reshapeGroupByRow(r, node.by));
    }
    ...
    async function hydrate(db, rows, parentModel, hydration) {
      ...
      for (const rel3 of hydration) {
        ...
        else await hydrateMany(db, rows, rel3, targetModel);
      }
    }
    ...
    async function applyRelationCounts(db, rows, parentModel, counts) {
      ...
      for (const relName of counts) {
        ...
        const placeholders = refs.map(() => "?").join(", ");
        const sql = `SELECT "${rel3.on}" AS fk, COUNT(*) AS c FROM "${targetModel.collection}" WHERE "${rel3.on}" IN (${placeholders}) GROUP BY "${rel3.on}"`;
        const groups = await (0, errors_1.withSqliteErrors)(() =>
          db.all(sql, encodeParams(refs)),
        );
        const byFk = /* @__PURE__ */ new Map();
        for (const g of groups) byFk.set(String(g.fk), Number(g.c));
        for (const r of rows)
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/sqlite/driver.js"(
    ...
    function libsqlDriver(client) {
      const run = (sql, params) =>
        client.execute(params.length ? { sql, args: params } : sql);
      return {
        kind: "sqlite",
      ...
      return {
        ...
        run: async (sql, params) => {
          ...
          return {
            ...
            lastInsertRowid: r.lastInsertId,
          };
        },
    ...
    function isSqliteDriver(v2) {
      return (
        ...
        typeof v2 === "object" &&
        v2.kind === "sqlite" &&
        typeof v2.all === "function" &&
        typeof v2.run === "function"
      );
    }
  },
});
    ...
    async function introspectSqlite(db) {
      ...
      for (const obj of objects) {
        ...
        for (const ix of indexList) {
          const cols = (
            await db.all(`PRAGMA index_info(${q(ix.name)})`, [])
          ).map((c) => c.name);
          indexes.push({
            name: ix.name,
            columns: cols,
        ...
        const fkList = await db.all(
          `PRAGMA foreign_key_list(${q(obj.name)})`,
          [],
        );
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/sqlite/adapter.js"(
    ...
    var SqliteAdapter = class {
      ...
      async doctor() {
        ...
        const driver = injected
          ? { installed: true, version: void 0 }
          : (0, missing_driver_1.isDriverInstalled)("sqlite");
        return {
          kind: "sqlite",
      ...
      get db() {
        if (!this._db)
          throw new Error(
            "[forge:sqlite] db accessed before connect() resolved",
          );
        return this._db;
      }
      sqliteOpts(opts) {
      ...
      async _track(op, node, model3, exec, countRows, semanticOp) {
        if (!this.emitter.hasListeners()) return exec();
        const c = await Promise.resolve().then(() =>
          __importStar(require_compile_from_ir4()),
        );
        const a2 =
          op === "select"
            ? c.compileSelect(node, model3)
      ...
      executeSelect(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeSqliteSelect)(
              this.db,
              node,
              model3,
              this.sqliteOpts(opts),
            ),
          (r) => r.length,
        );
      }
      executeCount(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeSqliteCount)(
              this.db,
              node,
              model3,
              this.sqliteOpts(opts),
      ...
      executeInsert(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeSqliteInsert)(
              this.db,
              node,
              model3,
              this.sqliteOpts(opts),
      ...
      executeUpdate(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeSqliteUpdate)(
              this.db,
              node,
              model3,
              this.sqliteOpts(opts),
      ...
      executeDelete(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeSqliteDelete)(
              this.db,
              node,
              model3,
              this.sqliteOpts(opts),
      ...
      executeGroupBy(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeSqliteGroupBy)(
              this.db,
              node,
              model3,
              this.sqliteOpts(opts),
      ...
      async *streamSelect(node, model3, _opts) {
        ...
        const { decodeRow } = await Promise.resolve().then(() =>
          __importStar(require_execute4()),
        );
        const a2 = compileSelect(node, model3);
        if (this.db.iterate) {
          ...
          for (const row of rows) yield decodeRow(model3, row);
        }
      }
      async applyProjectionAndHydration() {}
      async $queryRaw(fragment, opts) {
      ...
      async refreshView(model3, opts) {
        ...
        if (!sql)
          throw new Error(
            `[forge:sqlite] '${model3?.collection}' has no view SQL to refresh`,
          );
      ...
      async introspect() {
        const { introspectSqlite } = await Promise.resolve().then(() =>
          __importStar(require_introspect3()),
        );
    ...
    function rethrowDuckdbError(err) {
      ...
      if (errType === "Constraint" || /Constraint Error/i.test(msg)) {
        if (/duplicate key|UNIQUE constraint|Primary key conflict/i.test(msg)) {
          throw new errors_1.DbKnownError(
            "P2002",
            `Unique constraint failed: ${msg}`,
            { detail: msg },
          );
        }
        ...
        if (/foreign key/i.test(msg)) {
          throw new errors_1.DbKnownError(
            "P2003",
            `Foreign key constraint failed: ${msg}`,
            { detail: msg },
          );
        }
      }
...
var require_execute5 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/duckdb/execute.js"(
    ...
    async function executeDuckdbSelect(driver, node, model3, opts = {}) {
      ...
      const artifact = (0, compile_from_ir_1.compileSelect)(node, model3);
      const { rows } = await (0, errors_1.withDuckdbErrors)(() =>
        exec.query(artifact.sql, artifact.params),
      );
      let out = rows;
      if (node.distinct?.length) out = dedupeBy(out, node.distinct);
    ...
    async function executeDuckdbInsert(driver, node, model3, opts = {}) {
      const exec = opts.client ?? driver;
      const artifact = (0, compile_from_ir_1.compileInsert)(node, model3);
      const { rows, rowCount } = await (0, errors_1.withDuckdbErrors)(() =>
        exec.query(artifact.sql, artifact.params),
      );
      return { docs: rows, count: rowCount ?? rows.length };
    }
...
var require_introspect4 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/duckdb/introspect.js"(
    ...
    async function introspectDuckdb(driver) {
      ...
      const cols =
        await driver.query(`SELECT table_name, column_name, data_type, is_nullable, column_default
       FROM duckdb_columns() WHERE schema_name = current_schema()
       ORDER BY table_name, column_index`);
      const idx =
        await driver.query(`SELECT table_name, index_name, is_unique, sql
       FROM duckdb_indexes() WHERE schema_name = current_schema()`);
      const fks =
        await driver.query(`SELECT table_name, constraint_name, constraint_column_names, referenced_table, referenced_column_names
      ...
      for (const r of tables.rows) ensure(r.table_name);
      for (const r of cols.rows) {
        ensure(r.table_name).columns.push(normalizeColumn(r));
      }
      for (const r of idx.rows) {
      ...
      for (const r of fks.rows) {
        const onCols = Array.isArray(r.constraint_column_names)
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/duckdb/adapter.js"(
    ...
    var DuckdbAdapter = class {
      ...
      async doctor() {
        ...
        const driver = injected
          ? { installed: true, version: void 0 }
          : (0, missing_driver_1.isDriverInstalled)("duckdb");
        return {
          kind: "duckdb",
      ...
      get driver() {
        if (!this._driver)
          throw new Error(
            "[forge:duckdb] driver accessed before connect() resolved",
          );
        return this._driver;
      }
      duckdbOpts(opts) {
      ...
      async _track(op, node, model3, exec, countRows, semanticOp) {
        ...
        const {
          ...
          __importStar(require_compile_from_ir5()),
        );
        const artifact =
          op === "select"
            ? compileSelect(node, model3)
      ...
      executeSelect(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeDuckdbSelect)(
              this.handle(opts),
              node,
              model3,
              this.duckdbOpts(opts),
            ),
          (r) => r.length,
        );
      }
      executeCount(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeDuckdbCount)(
              this.handle(opts),
              node,
              model3,
              this.duckdbOpts(opts),
      ...
      executeInsert(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeDuckdbInsert)(
              this.handle(opts),
              node,
              model3,
              this.duckdbOpts(opts),
      ...
      executeUpdate(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeDuckdbUpdate)(
              this.handle(opts),
              node,
              model3,
              this.duckdbOpts(opts),
      ...
      executeDelete(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeDuckdbDelete)(
              this.handle(opts),
              node,
              model3,
              this.duckdbOpts(opts),
      ...
      executeGroupBy(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeDuckdbGroupBy)(
              this.handle(opts),
              node,
              model3,
              this.duckdbOpts(opts),
      ...
      async applyCascadesForDelete() {}
      async introspect() {
        const { introspectDuckdb } = await Promise.resolve().then(() =>
          __importStar(require_introspect4()),
        );
      ...
      async $queryRaw(fragment, opts) {
        ...
        const { sql, params } = compileSqlFragment(fragment, "postgres");
        const { withDuckdbErrors } = await Promise.resolve().then(() =>
          __importStar(require_errors5()),
        );
        const { rows } = await withDuckdbErrors(() =>
          this.handle(opts).query(sql, params),
        );
        return rows;
      }
      async $executeRaw(fragment, opts) {
        ...
        const { rowCount } = await withDuckdbErrors(() =>
          this.handle(opts).query(sql, params),
        );
        return rowCount ?? 0;
      }
...
var require_errors6 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/errors.js"(
    ...
    var NUMBER_MAP = {
      ...
      2627: {
        code: "P2002",
        build: (e) => `Unique constraint failed: ${e.message ?? ""}`,
      },
      2601: {
        code: "P2002",
        build: (e) => `Unique constraint failed: ${e.message ?? ""}`,
      ...
      547: {
        code: "P2003",
        build: (e) => `Foreign key constraint failed: ${e.message ?? ""}`,
      },
      // NOT NULL violation
      515: {
        code: "P2011",
        build: (e) => `Null constraint violation: ${e.message ?? ""}`,
      },
      // CHECK violation surfaces as 547 historically; nothing else clean.
      // Invalid object name (table not found)
      208: {
        code: "P2021",
        build: (e) => `Table does not exist: ${e.message ?? ""}`,
      },
      // Invalid column name
      207: {
        code: "P2022",
        build: (e) => `Column does not exist: ${e.message ?? ""}`,
      },
      // Deadlock
      1205: {
        code: "P2034",
        build: () => `Transaction deadlock \u2014 please retry`,
      },
      // Login failed
      18456: {
        code: "P1010",
        build: () => `Authentication failed for database user`,
      },
    };
    function rethrowMssqlError(err) {
      ...
      if (num != null && NUMBER_MAP[num]) {
        ...
        throw new errors_1.DbKnownError(m2.code, m2.build(e), {
          number: num,
          detail: e.message,
        });
      }
...
var require_execute6 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/execute.js"(
    ...
    async function executeMssqlSelect(driver, node, model3, opts = {}) {
      const exec = opts.client ?? driver;
      const artifact = (0, compile_from_ir_1.compileSelect)(node, model3);
      const { rows } = await (0, errors_1.withMssqlErrors)(() =>
        exec.query(artifact.sql, artifact.params),
      );
      let out = rows;
      if (node.distinct?.length) out = dedupeBy(out, node.distinct);
    ...
    async function executeMssqlInsert(driver, node, model3, opts = {}) {
      const exec = opts.client ?? driver;
      const artifact = (0, compile_from_ir_1.compileInsert)(node, model3);
      const { rows, rowCount } = await (0, errors_1.withMssqlErrors)(() =>
        exec.query(artifact.sql, artifact.params),
      );
      return { docs: rows, count: rowCount ?? rows.length };
    }
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/driver.js"(
    ...
    function mssqlDriver(pool) {
      const runQuery = async (sqlText, params) => {
        ...
        const rowCount =
          typeof result?.rowsAffected === "object" &&
...
var require_introspect5 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/introspect.js"(
    ...
    async function introspectMssql(driver) {
      const tables =
        await driver.query(`SELECT t.name AS table_name FROM sys.tables t
       JOIN sys.schemas s ON s.schema_id = t.schema_id
       WHERE s.name = SCHEMA_NAME()`);
      const cols =
        await driver.query(`SELECT c.TABLE_NAME AS table_name, c.COLUMN_NAME AS column_name,
      ...
      const idx =
        await driver.query(`SELECT t.name AS table_name, i.name AS index_name, i.is_unique AS is_unique,
            STUFF((
      ...
      const fks =
        await driver.query(`SELECT fk.name AS constraint_name, t.name AS table_name,
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mssql/adapter.js"(
    ...
    var MssqlAdapter = class {
      ...
      async doctor() {
        ...
        const driver = injected
          ? { installed: true, version: void 0 }
          : (0, missing_driver_1.isDriverInstalled)("mssql");
        return {
          kind: "mssql",
      ...
      get driver() {
        if (!this._driver)
          throw new Error(
            "[forge:mssql] driver accessed before connect() resolved",
          );
        return this._driver;
      }
      mssqlOpts(opts) {
      ...
      async _track(op, node, model3, exec, countRows, semanticOp) {
        ...
        const {
          ...
          __importStar(require_compile_from_ir6()),
        );
        const artifact =
          op === "select"
            ? compileSelect(node, model3)
      ...
      executeSelect(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMssqlSelect)(
              this.handle(opts),
              node,
              model3,
              this.mssqlOpts(opts),
      ...
      executeInsert(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMssqlInsert)(
              this.handle(opts),
              node,
              model3,
              this.mssqlOpts(opts),
      ...
      executeUpdate(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMssqlUpdate)(
              this.handle(opts),
              node,
              model3,
              this.mssqlOpts(opts),
      ...
      executeDelete(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMssqlDelete)(
              this.handle(opts),
              node,
              model3,
              this.mssqlOpts(opts),
      ...
      executeGroupBy(node, model3, opts) {
        return this._track(
          ...
          model3,
          () =>
            (0, execute_1.executeMssqlGroupBy)(
              this.handle(opts),
              node,
              model3,
              this.mssqlOpts(opts),
      ...
      async applyCascadesForDelete() {}
      async introspect() {
        const { introspectMssql } = await Promise.resolve().then(() =>
          __importStar(require_introspect5()),
        );
      ...
      async $queryRaw(fragment, opts) {
        ...
        const { sql, params } = compileSqlFragment(fragment, "postgres");
        const { withMssqlErrors } = await Promise.resolve().then(() =>
          __importStar(require_errors6()),
        );
        const { rows } = await withMssqlErrors(() =>
          this.handle(opts).query(sql, params),
        );
        return rows;
      }
      async $executeRaw(fragment, opts) {
        ...
        const { rowCount } = await withMssqlErrors(() =>
          this.handle(opts).query(sql, params),
        );
        return rowCount ?? 0;
      }
    ...
    function leafToRange(leaf) {
      ...
      switch (op) {
        ...
        case "in": {
          ...
          const ranges = value
            .filter((v2) => v2 !== null && v2 !== void 0)
            .map((v2) => IDBKeyRange.only(v2));
...
var require_predicate = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/predicate.js"(
    ...
    function compilePredicate(tree) {
      if (!tree) return exports.ALWAYS_TRUE;
      switch (tree.kind) {
        case "leaf":
    ...
    function compileLeaf(leaf) {
      ...
      switch (op) {
        ...
        case "in":
          return (r) =>
            Array.isArray(value) &&
            value.some((v2) => eqValue(get(r), v2, caseInsensitive));
        case "nin":
          return (r) =>
            Array.isArray(value) &&
            !value.some((v2) => eqValue(get(r), v2, caseInsensitive));
        case "contains":
          return (r) =>
            stringOp(get(r), value, caseInsensitive, (a2, b2) =>
              a2.includes(b2),
            );
        case "startsWith":
          return (r) =>
        ...
        case "has":
          return (r) =>
            Array.isArray(get(r)) &&
            get(r).some((x2) => eqValue(x2, value, caseInsensitive));
        case "hasSome":
          return (r) =>
            Array.isArray(get(r)) &&
            Array.isArray(value) &&
            value.some((v2) =>
              get(r).some((x2) => eqValue(x2, v2, caseInsensitive)),
            );
        case "hasEvery":
          return (r) =>
            Array.isArray(get(r)) &&
        ...
        case "isEmpty":
          return (r) => {
            ...
            const isEmpty =
              v2 == null || (Array.isArray(v2) && v2.length === 0);
        ...
        case "jsonPath": {
          ...
          return (r) => {
            ...
            switch (subOp) {
              ...
              case "in":
                return (
                  Array.isArray(value) && value.some((v2) => eqValue(at, v2))
                );
              case "has":
...
var require_planner = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/planner.js"(
      ...
      if (primary) {
        ...
        if (range) {
          best = {
            ...
            // primary-key cursor
            range,
            residual: (0, predicate_1.compilePredicate)(
              removeLeaf(where, primary.leaf),
            ),
            score: 100,
      ...
      for (const idx of indexes) {
        ...
        if (cand.score > best.score) {
          best = {
            ...
            range: cand.range,
            residual: (0, predicate_1.compilePredicate)(
              removeLeaves(where, cand.usedLeaves),
            ),
            score: cand.score,
        ...
        for (const idx of indexes) {
          ...
          if (keys.length === 1 && keys[0] === orderField.field) {
            best = {
              ...
              range: {
                range: null,
                direction: orderField.direction === "desc" ? "prev" : "next",
              },
              residual: (0, predicate_1.compilePredicate)(where),
              score: 20,
    ...
    function scoreIndex(idx, leaves, orderField) {
      ...
      const rangeLeaf = leaves.find(
        (x2) =>
          x2.field === col &&
          ["lt", "lte", "gt", "gte", "startsWith"].includes(x2.op),
      );
      if (rangeLeaf) {
    ...
    function allIndexes(model3) {
      ...
      for (const idx of model3.indexes ?? []) out.push(idx);
      return out;
    }
    ...
    function removeLeaves(w, leaves) {
      if (!w) return void 0;
      if (w.kind === "leaf") return leaves.includes(w) ? void 0 : w;
      if (w.kind === "and") {
        const kept = w.children
          .map((c) => removeLeaves(c, leaves))
          .filter(Boolean);
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/ddl.js"(
    ...
    function buildDDLPlan(schema) {
      ...
      for (const key of Object.keys(schema)) {
        ...
        if (!model3 || model3.view) continue;
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/open.js"(
    ...
    async function openDb(opts) {
      if (typeof indexedDB === "undefined") {
        throw new Error(
          'forge-orm IndexedDB adapter requires a browser or worker environment. Detected server-side runtime \u2014 use a server adapter (postgres/mysql/sqlite/mongo) or route this code path client-only (Next.js: "use client" or dynamic({ ssr: false })).',
        );
      }
      ...
      if (diff.hasWork) {
        ...
        const upgraded = await rawOpen(opts.name, nextVersion, (db, txn) => {
          for (const create of diff.createStores) {
            const store = db.createObjectStore(create.storeName, {
    ...
    function diffAgainstLive(plan, db) {
      ...
      if (liveStoreNames.size > 0) {
        ...
        for (const want of plan.stores) {
          ...
          const drop = Array.from(liveIdxNames).filter(
            (n) => !wantIdxNames.has(n),
          );
      ...
      for (const live of liveStoreNames) {
        if (!wantStoreNames.has(live)) {
          pending.push(
            `drop store ${live} \u2014 schema no longer declares it (destructive; skipped)`,
          );
        }
      }
      return {
    ...
    function rawOpen(name, version, onUpgrade) {
      return new Promise((resolve, reject) => {
        ...
        req.onblocked = () =>
          reject(
            new Error(
              `IDB open blocked \u2014 close other tabs holding ${name}`,
            ),
          );
      });
    }
    function deleteDb(name) {
      return new Promise((resolve, reject) => {
        ...
        req.onerror = () => reject(req.error);
        req.onblocked = () =>
          reject(new Error(`deleteDatabase blocked on ${name}`));
      });
    }
  },
});
        ...
        ids.map(
          (id) =>
            new Promise((resolve, reject) => {
              ...
              req.onsuccess = () => {
                if (req.result !== void 0) out.push(req.result);
                resolve();
              };
              req.onerror = () => reject(req.error);
            }),
...
var require_hydration = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/hydration.js"(
    ...
    async function hydrate(db, schema, parentModelKey, parents, hydration) {
      ...
      for (const rel3 of hydration) {
        ...
        if (rel3.kind === "many") {
          ...
          let rows = await (0, cursor_scan_1.cursorScanIds)(
            db,
            targetModel.collection,
            childIds,
          );
    ...
    async function applyRelationCounts(
      ...
      for (const p2 of parents) {
        if (typeof p2._count !== "object" || p2._count === null) p2._count = {};
      }
      for (const relName of counts) {
        const rel3 = rels[relName];
        if (!rel3) {
          for (const p2 of parents) p2._count[relName] = 0;
          continue;
        }
        const targetModel = schema[rel3.target];
        if (!targetModel) {
      ...
      await Promise.all(
        keys.map(
          (k) =>
            new Promise((resolve, reject) => {
              const req = idx
                ? idx.openCursor(IDBKeyRange.only(k))
                : store.openCursor();
              req.onsuccess = () => {
                const cur = req.result;
                if (!cur) return resolve();
...
var require_coerce2 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/coerce.js"(
    ...
    function materializeDefault(def) {
      if (!def.default) return void 0;
      if (def.default.kind === "now") return /* @__PURE__ */ new Date();
...
var require_vector = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/vector.js"(
    ...
    function vectorDistance(a2, b2, metric) {
      if (a2.length !== b2.length) return Infinity;
      switch (metric) {
        case "cosine":
    ...
    function dot(a2, b2) {
      let s = 0;
      for (let i = 0; i < a2.length; i++) s += a2[i] * b2[i];
      return s;
    }
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/geo.js"(
    ...
    function pointInMultiPolygon(mp, p2) {
      for (const poly of mp) {
        ...
        if (!pointInRing(outer, p2)) continue;
        if (holes.some((h) => pointInRing(h, p2))) continue;
        return true;
      }
      return false;
    }
    function pointInRing(ring, p2) {
      ...
      for (let i = 0, j = n - 1; i < n; j = i++) {
        ...
        const xj = ring[j].lng,
          yj = ring[j].lat;
        const intersect =
          yi2 > p2.lat !== yj > p2.lat &&
          p2.lng < ((xj - xi2) * (p2.lat - yi2)) / (yj - yi2) + xi2;
...
var require_fts = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/fts.js"(
    ...
    async function searchByTokens(db, storeName, field, query) {
      ...
      if (terms.length === 0) return /* @__PURE__ */ new Set();
      const tx = db.transaction(storeName, "readonly");
      const store = tx.objectStore(storeName);
      ...
      if (perTerm.length === 0) return /* @__PURE__ */ new Set();
...
var require_errors7 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/errors.js"(
    ...
    function wrapIdbError(err) {
      if (err instanceof errors_1.DbKnownError) return err;
      if (err instanceof Error) {
        const code = CODE_MAP[err.name] ?? "P2010";
        return new errors_1.DbKnownError(code, err.message, {
    ...
    function notFound(collection, where) {
      return new errors_1.DbKnownError(
        "P2025",
        `No ${collection} found matching the given criteria`,
        { modelName: collection, cause: where },
      );
    }
  },
});
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/execute.js"(
    ...
    async function executeSelect(db, node, model3, _opts = {}, schemaOverride) {
      return (0, errors_1.withIdbErrors)(async () => {
        ...
        let idFilter = null;
        if (searchLeaf) {
          idFilter = await (0, fts_1.searchByTokens)(
            db,
            storeName,
            searchLeaf.field,
            String(searchLeaf.value),
          );
          if (idFilter.size === 0) return [];
        }
        const nearLeaf = findLeaf(node.where, "near");
        const nearOrder = node.orderBy?.find((o) => o.nearTo);
        const plan = (0, planner_1.planSelect)(
          model3,
          stripPostFilterOps(node.where),
          node.orderBy,
        );
        const needsPostSort = !!node.orderBy?.length && !plan.orderByFree;
        const deferSlice =
          !!nearOrder ||
          (!!node.cursor && Object.keys(node.cursor.fields).length > 0) ||
          needsPostSort;
        ...
        if (idFilter)
          rows = rows.filter((r) =>
            idFilter.has(r[(0, planner_1.primaryKeyField)(model3)]),
          );
        if (nearLeaf) {
        ...
        if (nearOrder?.nearTo) {
          ...
          if (isVector) {
            ...
            for (const r of rows) {
              ...
              r._distance = rv
                ? (0, vector_1.vectorDistance)(rv, nt2.vector, metric)
                : Infinity;
            }
          } else {
            for (const r of rows) {
              const p2 = r[nearOrder.field];
              r._distanceMeters = p2
                ? (0, geo_1.haversineMeters)({ lng: nt2.lng, lat: nt2.lat }, p2)
                : Infinity;
            }
          }
        ...
        if (node.cursor && Object.keys(node.cursor.fields).length > 0) {
          ...
          if (node.offset) rows = rows.slice(node.offset);
          if (node.limit !== void 0) rows = rows.slice(0, node.limit);
        }
        if (node.distinct?.length) {
          const seen = /* @__PURE__ */ new Set();
          rows = rows.filter((r) => {
            const key = JSON.stringify(
              node.distinct.map((f3) => r[f3] ?? null),
            );
        ...
        if (node.hydration?.length)
          rows = await (0, hydration_1.hydrate)(
            db,
            schema,
            node.model,
            rows,
        ...
        if (node.projection?.counts?.length)
          await (0, hydration_1.applyRelationCounts)(
            db,
            schema,
            node.model,
            rows,
    ...
    function project(row, plan, hydration) {
      if (plan.exclusive) {
        const out = {};
        for (const f3 of plan.fields) out[f3] = row[f3];
        for (const rel3 of hydration ?? []) out[rel3.name] = row[rel3.name];
      ...
      if (plan.omit && plan.omit.length) {
        const out = { ...row };
        for (const f3 of plan.omit) delete out[f3];
        return out;
      }
      return row;
    }
    ...
    function stripPostFilterOps(w) {
      ...
      const walk = (n) => {
        if (!n) return n;
        if (n.kind === "leaf") return STRIP.has(n.op) ? void 0 : n;
        if (n.kind === "and" || n.kind === "or") {
          const c = n.children.map(walk).filter(Boolean);
          if (c.length === 0) return void 0;
    ...
    async function executeCount(db, node, model3, _opts = {}) {
      return (0, errors_1.withIdbErrors)(async () => {
        ...
        const rows = await (0, cursor_scan_1.cursorScan)(db, {
          storeName: model3.collection,
          plan,
        });
    ...
    async function executeInsert(db, node, model3, _opts = {}) {
      return (0, errors_1.withIdbErrors)(async () => {
        const pk = (0, planner_1.primaryKeyField)(model3);
        const searchable = Object.entries(model3.fields)
          .filter(([, f3]) => f3.searchable)
          .map(([n]) => n);
        ...
        for (const raw of node.rows) {
          const row = (0, coerce_1.coerceInbound)(model3, raw, {
            forCreate: true,
          });
    ...
    async function executeUpdate(db, node, model3, opts = {}) {
      return (0, errors_1.withIdbErrors)(async () => {
        const searchable = Object.entries(model3.fields)
          ...
          .map(([n]) => n);
        if (node.upsertCreate) {
          const found = await executeSelect(
            db,
            {
              kind: "select",
              model: node.model,
          ...
          if (found.length === 0) {
            const created = await executeInsert(
              db,
              {
                kind: "insert",
                model: node.model,
        ...
        const matches = await executeSelect(
          db,
          {
            kind: "select",
            model: node.model,
        ...
        for (const r of matches) {
          ...
          if (node.unset) for (const f3 of node.unset) delete patch[f3];
    ...
    async function executeGroupBy(db, node, model3, _opts = {}) {
      return (0, errors_1.withIdbErrors)(async () => {
        ...
        for (const r of rows) {
          const key = {};
          for (const f3 of node.by) key[f3] = r[f3];
        ...
        for (const g of groups.values()) {
          ...
          if (node._count) {
            ...
            for (const [f3, want] of Object.entries(node._count)) {
              if (f3 === "_all" || !want) continue;
              c[f3] = g.rows.filter((r) => r[f3] != null).length;
            }
            bucket._count = c;
          }
          if (node._sum)
            bucket._sum = mapAgg(g.rows, node._sum, (nums) =>
              nums.reduce((a2, b2) => a2 + b2, 0),
            );
          if (node._avg)
            bucket._avg = mapAgg(g.rows, node._avg, (nums) =>
              nums.length
                ? nums.reduce((a2, b2) => a2 + b2, 0) / nums.length
                : 0,
            );
          if (node._min)
            bucket._min = mapAgg(g.rows, node._min, (nums) =>
              nums.length ? Math.min(...nums) : null,
            );
          if (node._max)
            bucket._max = mapAgg(g.rows, node._max, (nums) =>
    ...
    async function walk(ctx, modelKey, parents) {
      ...
      for (const [childKey, childModelRaw] of Object.entries(ctx.schema)) {
        ...
        for (const rel3 of Object.values(rels)) {
          if (rel3.target !== modelKey) continue;
          if (rel3.kind !== "one") continue;
          if (rel3.inverse) continue;
          ...
          for (const pid of parentIds) {
            ...
            await new Promise((resolve, reject) => {
              const req = idx
                ? idx.openCursor(IDBKeyRange.only(pid))
                : store.openCursor();
              req.onsuccess = () => {
                const cur = req.result;
                if (!cur) return resolve();
          ...
          if (action === "Restrict") {
            throw new Error(
              `onDelete Restrict: cannot delete ${modelKey} \u2014 ${children.length} child ${childKey} row(s) exist`,
            );
          }
          if (action === "Cascade") {
            await walk(ctx, childKey, children);
            const childPk = (0, planner_1.primaryKeyField)(childModel);
            await (0, execute_1.executeDelete)(
              ctx.db,
              {
                kind: "delete",
                model: childKey,
    ...
    async function introspect(db) {
      ...
      for (const n of names) {
        ...
        const indexes = Array.from(store.indexNames).map((iName) => {
          ...
          const columns2 = Array.isArray(i.keyPath)
            ? [...i.keyPath]
            : [String(i.keyPath)];
        ...
        if (typeof store.keyPath === "string") push(store.keyPath);
          ...
          for (const k of store.keyPath) push(String(k));
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/indexeddb/adapter.js"(
    ...
    var IndexeddbAdapter = class {
      ...
      get db() {
        if (!this._db)
          throw new Error(
            "[forge:indexeddb] db accessed before connect() resolved",
          );
        return this._db;
      }
      ...
      executeSelect(node, model3, opts) {
        return this._track(
          "select",
          node,
          () => (0, execute_1.executeSelect)(this.db, node, model3, opts ?? {}),
          (r) => r.length,
        );
      }
      executeCount(node, model3, opts) {
        return this._track(
          "count",
          node,
          () => (0, execute_1.executeCount)(this.db, node, model3, opts ?? {}),
          () => 1,
        );
      }
      executeInsert(node, model3, opts) {
        return this._track(
          "insert",
          node,
          () => (0, execute_1.executeInsert)(this.db, node, model3, opts ?? {}),
          (r) => r.count,
        );
      }
      executeUpdate(node, model3, opts) {
        return this._track(
          "update",
          node,
          () => (0, execute_1.executeUpdate)(this.db, node, model3, opts ?? {}),
          (r) => r.count,
          opts?.semanticOp,
        );
      }
      executeDelete(node, model3, opts) {
        return this._track(
          "delete",
          node,
          () => (0, execute_1.executeDelete)(this.db, node, model3, opts ?? {}),
          (r) => r.count,
        );
      }
      executeGroupBy(node, model3, opts) {
        return this._track(
          ...
          node,
          () =>
            (0, execute_1.executeGroupBy)(this.db, node, model3, opts ?? {}),
          (r) => r.length,
        );
      }
      ...
      async $queryRaw() {
        throw new Error(
          "IndexedDB has no SQL query language; use db.<model>.aggregate or model methods.",
        );
      }
      async $executeRaw() {
        throw new Error(
    ...
    function keyForModel(schema, model3) {
      for (const [k, v2] of Object.entries(schema)) {
        if (v2.collection === model3.collection) return k;
      }
      return void 0;
    }
    function createIndexeddbAdapter(driver) {
      return new IndexeddbAdapter(
        driver && (0, driver_1.isIdbDriver)(driver) ? driver : void 0,
      );
    }
    var _default;
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/shared/mongo-to-sql-where.js"(
    ...
    function isScalar(v2) {
      ...
      if (
        ...
        return true;
      if (v2 instanceof Date) return true;
      return false;
    }
    function literal(v2) {
      if (typeof v2 === "string") return `'${v2.replace(/'/g, "''")}'`;
      if (typeof v2 === "number")
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/sqlite/ddl.js"(
    ...
    function buildFtsTables(m2) {
      ...
      for (const [name, fdef] of Object.entries(m2.fields)) {
        if (fdef.searchable) cols.push(name);
      }
    ...
    function buildCreateTable(m2, schema) {
      ...
      for (const [, rel3] of Object.entries(rels)) {
        ...
        cols.push(
          `FOREIGN KEY (${d2.quoteIdent(r.on)}) REFERENCES ${d2.quoteIdent(targetModel.collection)} (${d2.quoteIdent(r.refs)})${onDelete}`,
        );
      }
  ...
  ${cols.join(",\n  ")}
    ...
    function renderDefault(field) {
      ...
      switch (field.default.kind) {
        ...
        case "literal": {
          ...
          if (v2 === null) return " DEFAULT NULL";
          if (typeof v2 === "boolean") return ` DEFAULT ${v2 ? 1 : 0}`;
          if (typeof v2 === "number") return ` DEFAULT ${v2}`;
          if (typeof v2 === "string") return ` DEFAULT ${escapeSqlString(v2)}`;
    ...
    function buildIndexes(m2) {
      ...
      for (const idx of m2.indexes ?? []) {
        ...
        const name =
          i.name ??
          tableConstraintName(table, "idx", i.expression ? ["expr"] : cols);
        ...
        if (i.expression) {
          ...
          payload = cols
            .map((c) => {
              const dir = i.keys[c];
              if (dir === "text") return `${d2.quoteIdent(c)}`;
        ...
        if (typeof i.where === "string" && i.where.trim()) {
          ...
          const translated = (0, mongo_to_sql_where_1.mongoToSqlWhere)(
            i.where,
            {
          ...
          if (translated) {
            ...
            console.warn(
              `[forge:push:sqlite] index '${name}' has an object-form 'where' that uses operators outside the translator's coverage. Pass a raw SQL string in 'where' or simplify the object. Filter omitted.`,
            );
          }
        ...
        if (i.include?.length) {
          console.warn(
            `[forge:push:sqlite] index '${name}' uses include \u2014 INCLUDE is a Postgres-only feature. Ignored on SQLite.`,
          );
        }
        if (i.method === "vector") {
          console.warn(
            `[forge:push:sqlite] index '${name}' uses method:'vector' \u2014 SQLite vector indexes need sqlite-vec (CREATE VIRTUAL TABLE \u2026 USING vec0). forge-orm doesn't auto-create the vec0 mirror; do it manually if you need ANN search, or use brute-force JSON-array scans.`,
          );
        }
        if (i.method === "spatial") {
          console.warn(
            `[forge:push:sqlite] index '${name}' uses method:'spatial' \u2014 SQLite spatial indexes are created by the adapter at runtime via SpatiaLite (or skipped in fallback mode). The CREATE INDEX statement below lands as a plain b-tree, which is mostly a no-op for geo queries.`,
          );
        } else if (i.method && i.method !== "btree") {
          console.warn(
            `[forge:push:sqlite] index '${name}' specifies method='${i.method}' \u2014 SQLite only supports BTREE. Method ignored.`,
          );
        }
        if (i.visible === false || i.parser) {
          console.warn(
            `[forge:push:sqlite] index '${name}' uses MySQL-only fields (visible / parser). Ignored on SQLite.`,
          );
        }
        out.push({
          kind: "index",
      ...
      try {
        for (const stmt of ddl) {
          ...
          try {
            ...
            log(
              `  \u2717 ${stmt.kind.padEnd(11)} ${stmt.name}  \u2192  ${err?.message ?? err}`,
            );
          }
        }
        await db.exec("COMMIT");
...
var require_diff_core = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/scripts/diff-core.js"(
    ...
    function matchesIgnore(name, spec) {
      for (const p2 of spec) {
        if (typeof p2 === "string") {
          if (p2 === name) return true;
        } else if (p2 instanceof RegExp) {
          if (p2.test(name)) return true;
        }
      }
      return false;
    }
    ...
    function canonOrdered(v2) {
      ...
      if (Array.isArray(v2)) return v2.map(canonOrdered);
      const out = {};
    ...
    function expectedFromSchema(schema) {
      ...
      for (const key of Object.keys(schema)) {
        ...
        if (m2.view) {
          views.push({
            name: m2.collection,
            materialised: m2.view.materialised === true,
          });
          continue;
        }
        ...
        for (const [name, fdef] of Object.entries(m2.fields)) {
          ...
          if (fdef.kind === "id") idCol = name;
        }
        const indexSigs = /* @__PURE__ */ new Set();
        const indexDecls = [];
        if (idCol) indexSigs.add(indexSig(true, [idCol]));
        for (const [name, fdef] of Object.entries(m2.fields)) {
          const fd = fdef;
        ...
        for (const rel3 of Object.values(m2.relations())) {
          ...
          if (r.inverse) continue;
          if (!m2.fields[r.on]) continue;
          if (m2.fields[r.on]?.kind === "id") continue;
    ...
    function diffIntrospection(schema, actual, ignore = []) {
      ...
      for (const [name, exp] of expected.tables) {
        ...
        if (!act) {
          items.push({
            ...
            direction: "missing",
            table: name,
            detail: `table '${name}' declared in schema but not in DB`,
          });
          continue;
        }
            ...
            if (checkTypes) {
              ...
              if (ec && dc && ec !== dc) {
                items.push({
                  ...
                  direction: "mismatch",
                  table: name,
                  detail: `column '${col}': schema=${ec} db=${ac.type}`,
                });
              }
            }
          }
          for (const ac of act.columns) {
            if (!exp.columns.has(ac.name))
              items.push({
                ...
                direction: "extra",
                table: name,
                detail: `column '${ac.name}' in DB but not in schema`,
              });
          }
        }
        ...
        for (const sig of actSigs) {
          if (sig.startsWith("u:") && !exp.indexSigs.has(sig))
            items.push({
              ...
              direction: "extra",
              table: name,
              detail: `unique index ${sig} in DB but not in schema`,
            });
        }
          ...
          if (ix.method !== void 0) {
            ...
            if (expM !== ix.method) {
              items.push({
                ...
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' method: schema=${expM} db=${ix.method}`,
              });
            }
          }
          const expWhereStr =
            typeof decl.where === "string" ? decl.where.trim() : void 0;
          const expPfe =
            decl.partialFilterExpression ??
            (typeof decl.where === "object" ? decl.where : void 0);
          if (ix.where !== void 0 && (expWhereStr || ix.where)) {
            ...
            if (a2 !== b2)
              items.push({
                ...
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' where: schema=${a2 || "\u2205"} db=${b2}`,
              });
          }
          if (ix.partialFilterExpression !== void 0) {
            ...
            if (a2 !== b2)
              items.push({
                ...
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' partialFilter: schema=${a2} db=${b2}`,
              });
          }
          if (ix.include !== void 0) {
            ...
            if (a2 !== b2)
              items.push({
                ...
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' include: schema=[${a2}] db=[${b2}]`,
              });
          }
          if (ix.expression !== void 0 && (decl.expression || ix.expression)) {
            ...
            if (ap !== bp)
              items.push({
                ...
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' expression: schema='${a2}' db='${b2}'`,
              });
          }
          if (ix.collation && decl.collation) {
            const dk = Object.keys(decl.collation);
            const projected = {};
            for (const k of dk) projected[k] = ix.collation[k];
            ...
            if (a2 !== b2)
              items.push({
                ...
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' collation: schema=${a2} db=${b2}`,
              });
          }
          if (
            ix.wildcardProjection !== void 0 &&
            (decl.wildcardProjection || ix.wildcardProjection)
          ) {
            const a2 = JSON.stringify(
              canonOrdered(decl.wildcardProjection ?? {}),
            );
            const b2 = JSON.stringify(
              canonOrdered(ix.wildcardProjection ?? {}),
            );
            if (a2 !== b2)
              items.push({
                kind: "index",
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' wildcardProjection: schema=${a2} db=${b2}`,
              });
          }
          if (ix.keySpec) {
            ...
            if (a2 !== b2)
              items.push({
                ...
                direction: "mismatch",
                table: name,
                detail: `index '${decl.name}' keys: schema=${a2} db=${b2}`,
              });
          }
        }
        if (dialect !== "mongo") {
          const actFks = new Set(
            act.foreignKeys.map(
              (f3) => `${f3.column}->${f3.refTable}.${f3.refColumn}`,
            ),
          );
      ...
      for (const [name] of actualTables) {
        ...
        if (expected.views.some((v2) => v2.name === name)) continue;
        ...
        items.push({
          ...
          direction: "extra",
          table: name,
          detail: `table '${name}' in DB but not in schema`,
        });
      }
  ...
  (ignored ${r.ignored.length} table${r.ignored.length === 1 ? "" : "s"}: ${r.ignored.join(", ")})`
      ...
      const lines = [
        `\u2717 drift detected on ${r.dialect} (${r.items.length} issue${r.items.length === 1 ? "" : "s"}):`,
      ];
      for (const it2 of r.items) {
        const tag =
          it2.direction === "missing"
            ? "\u2212"
            : it2.direction === "extra"
              ? "+"
              : "\u2260";
...
var require_drift_apply = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/wasm/drift-apply.js"(
    ...
    async function applyDrift(db, opts) {
      ...
      const drift = (0, diff_core_1.diffIntrospection)(
        opts.schema,
        introspection,
      );
      ...
      for (const key of Object.keys(opts.schema)) {
        ...
        if (m2?.collection) modelByCollection.set(m2.collection, m2);
      }
      const adds = [];
      ...
      try {
        for (const a2 of adds) {
          ...
          try {
            ...
            out.failures.push({
              name: `${a2.table}.${a2.column}`,
              error: err?.message ?? String(err),
            });
            log(
              `  \u2717 add-column  ${a2.table}.${a2.column}  \u2192  ${err?.message ?? err}`,
            );
          }
        }
        await db.exec("COMMIT");
...
var require_migrate2 = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/wasm/migrate.js"(
    ...
    async function runMigrate(driver, opts = {}) {
      ...
      if (!schema) {
        throw new Error(
          "[forge:wasm] $migrate(): no active schema. Pass createDb({ schema }) or runMigrate(driver, { schema }).",
        );
      }
      const ddl = (0, ddl_1.buildSchemaDDL)(schema);
      const createReport = await (0, migrate_1.applyMigration)(
        driver,
        ddl,
      ...
      const driftReport = await (0, drift_apply_1.applyDrift)(
        driver,
        opts.logger ? { schema, logger: opts.logger } : { schema },
      );
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/wasm/browser-doctor.js"(
    ...
    async function detectEnvironment() {
      ...
      if (storage?.estimate) {
        try {
          ...
          if (est.quota) estimatedQuotaMB = Math.round(est.quota / 1048576);
          if (est.usage) estimatedUsageMB = Math.round(est.usage / 1048576);
        } catch {}
      }
      return {
        runtime,
    ...
    async function browserDoctor(driver) {
      ...
      const version = await probe(() =>
        driver.get("SELECT sqlite_version() AS v", []),
      );
      ...
      const fts5 = await probe(async () => {
        await driver.exec(
          "CREATE VIRTUAL TABLE IF NOT EXISTS __forge_doctor_fts USING fts5(x)",
        );
        await driver.exec("DROP TABLE IF EXISTS __forge_doctor_fts");
      });
      const rtree = await probe(async () => {
        await driver.exec(
          "CREATE VIRTUAL TABLE IF NOT EXISTS __forge_doctor_rt USING rtree(id, minX, maxX, minY, maxY)",
        );
        await driver.exec("DROP TABLE IF EXISTS __forge_doctor_rt");
      });
      const sqliteVec = await probe(() =>
        driver.get("SELECT vec_version() AS v", []),
      );
      ...
      if (!environment.opfs) {
        notes.push(
          "OPFS unavailable \u2014 falling back to :memory: storage. Data is lost on tab close. Upgrade to a modern browser (Chrome 109+, Edge 109+, Safari 16.4+, Firefox 111+).",
        );
      }
      if (environment.persistent === "requestable") {
        notes.push(
          "Storage is evictable. Call await navigator.storage.persist() at app boot to flip into persistent mode (especially important on iOS Safari to avoid the 7-day Intelligent-Tracking-Prevention eviction).",
        );
      }
      if (!sqlite.fts5) {
        notes.push(
          "FTS5 not compiled into this sqlite-wasm build. f.text().searchable() falls back to a LIKE-based prefilter \u2014 slower on large tables.",
        );
      }
      if (!sqlite.rtree) {
        notes.push(
          "R-Tree extension not compiled in. f.geoPoint() falls back to bbox + Haversine post-filter in JS. Acceptable to ~50k rows; rebuild with the rtree extension for native spatial index. See forge-orm/wasm-pro.",
        );
      }
      if (!sqlite.sqliteVec) {
        notes.push(
          "sqlite-vec not loaded. f.vector() falls back to brute-force cosine distance in JS. Build forge-orm/wasm-pro to bundle sqlite-vec for HNSW-grade vector search.",
        );
      }
...
var require_factory = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/factory.js"(
    ...
    async function createDb2(opts) {
      if (opts.schema) (0, active_1.setActiveSchema)(opts.schema);
    ...
    async function pickAndConnect(opts) {
      ...
      const url =
        "url" in opts && opts.url ? opts.url : buildUrlFromStructured(opts);
      const kind =
        ("type" in opts && opts.type) || (0, detect_1.detectAdapterKind)(url);
      if (!kind) {
  ...
  Pass an explicit type: createDb({ type: 'mongo' | 'postgres' | 'mysql' | 'sqlite', url })`);
      ...
      if ("type" in opts && opts.type && "url" in opts && opts.url) {
        ...
        if (detected && detected !== opts.type) {
          throw new Error(
            `[forge] type='${opts.type}' but URL prefix indicates '${detected}'. Fix one of them before continuing.`,
          );
        }
      }
    ...
    function buildUrlFromStructured(o) {
      ...
      const auth = o.user
        ? `${encodeURIComponent(o.user)}${o.password ? `:${encodeURIComponent(o.password)}` : ""}@`
        : "";
    ...
    function makeDb(adapter, _url, runtime = { strict: false }) {
      ...
      const root = new Proxy(
        {},
        {
          get: (_t3, prop) => {
            ...
            if (!model3) return void 0;
            if (!cache[key]) {
              cache[key] = new collection_1.CollectionWrapper(
                model3,
                void 0,
                adapter,
                runtime.strict,
      ...
      async function $migrate(opts) {
        if (adapter.kind === "sqlite") {
          const { runMigrate } = await Promise.resolve().then(() =>
            __importStar(require_migrate2()),
          );
        ...
        if (adapter.kind === "indexeddb") {
          const { runMigrate } = await Promise.resolve().then(() =>
            __importStar(require_migrate3()),
          );
          const url = _url ?? "forge";
          const name = url.startsWith("idb:")
            ? url.slice(4) || "forge"
            : url.startsWith("indexeddb:")
              ? url.slice(10) || "forge"
              : url || "forge";
          const { getActiveSchema } = await Promise.resolve().then(() =>
            __importStar(require_active()),
          );
          return runMigrate({
            name,
        ...
        throw new Error(
          `[forge] $migrate() is only supported on sqlite + indexeddb adapters today. For ${adapter.kind} use the CLI: 'npx forge push'.`,
        );
      }
      async function $doctor() {
        if (adapter.kind === "sqlite") {
          const { browserDoctor } = await Promise.resolve().then(() =>
            __importStar(require_browser_doctor()),
          );
          const driver = adapter.db;
      ...
      async function $diff(opts) {
        const { diffIntrospection } = await Promise.resolve().then(() =>
          __importStar(require_diff_core()),
        );
      ...
      function $runCommandRaw(command) {
        ...
        return client_1.dbClient.db.command(
          (0, coerce_1.coerceExtendedJSON)(command),
        );
      }
        ...
        return new Proxy(
          {},
          {
            get: (_t3, prop) => {
              ...
              if (key === "$transaction")
                return (a2) =>
                  Array.isArray(a2) ? Promise.all(a2) : a2(makeTx(session));
              if (key === "$queryRaw")
                return makeRawCaller((frag) =>
                  adapter.$queryRaw(frag, { session }),
                );
              if (key === "$executeRaw")
                return makeRawCaller((frag) =>
                  adapter.$executeRaw(frag, { session }),
                );
              if (key === "$runCommandRaw") {
                if (adapter.kind !== "mongo") {
                  return () =>
                    Promise.reject(
                      new Error("[forge] $runCommandRaw is Mongo-only."),
                    );
                }
              ...
              if (!model3) return void 0;
              if (!txCache[key]) {
                txCache[key] = new collection_1.CollectionWrapper(
                  model3,
                  session,
                  adapter,
                  runtime.strict,
    ...
    function wasmSqliteDriver(opts) {
      ...
      function attach(worker) {
        worker.addEventListener("message", (ev) => {
          ...
          if (msg.ok) p2.resolve(msg);
          else p2.reject(buildError(msg));
        });
        worker.addEventListener("error", (ev) => {
          const err = new Error(
            `[forge:wasm] worker error: ${ev.message ?? "unknown"}`,
          );
        ...
        return new Promise((resolve, reject) => {
          ...
          if (timeoutMs > 0) {
            p2.timer = setTimeout(() => {
              ...
              reject(
                new Error(
                  `[forge:wasm] request timed out after ${timeoutMs}ms (${String(body.type)})`,
                ),
              );
            }, timeoutMs);
          }
      ...
      return {
        ...
        run: (sql, params) =>
          enqueue(async () => {
            ...
            return {
              ...
              ...(reply.lastInsertRowid != null
                ? { lastInsertRowid: reply.lastInsertRowid }
                : {}),
            };
          }),
        exec: (sql) =>
        ...
        close: async () => {
          ...
          const w = workerPromise
            ? await workerPromise.catch(() => null)
            : null;
          workerPromise = null;
          opened = null;
          if (w) w.terminate();
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/adapters/mongo/driver.js"(
    ...
    function mongoDriver(client, dbName) {
      if (!client || typeof client.db !== "function") {
        throw new Error(
          "[forge] mongoDriver() expects a MongoClient (with a .db() method)",
        );
      }
  ...
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/null-markers.js"(
    ...
    function isForgeNullMarker(v2) {
      return (
        ...
        typeof v2 === "object" &&
        "__forge" in v2 &&
        ["DbNull", "JsonNull", "AnyNull"].includes(v2.__forge)
      );
    }
  },
});
      ...
      const offQ = db.$on("query", (e) => {
        ...
        const span = opts.tracer.startSpan(spanName, {
          attributes: {
            ...
            ...(recordStmt && typeof e.sql === "string"
              ? { "db.statement": truncate(e.sql, maxLen) }
              : {}),
          },
        });
...
var require_dist = __commonJS({
  "node_modules/.pnpm/forge-orm@2.6.4/node_modules/forge-orm/dist/index.js"(
    ...
    exports.setActiveSchema =
      ...
      exports.model =
      exports.f =
      exports.forgeValidator =
      exports.isForgeNullMarker =
      exports.ForgeAnyNull =
      exports.ForgeJsonNull =
      exports.ForgeDbNull =
      exports.FORGE_COL =
      exports.isColRef =
      exports.col =
      ...
      exports.buildOrderBy =
      exports.buildWhereTree =
      exports.buildGroupBy =
      exports.buildDelete =
      exports.buildUpdate =
      exports.buildInsert =
      exports.buildCount =
      exports.buildSelect =
      exports.detectAdapterKind =
      exports.ForgeMissingDriverError =
      exports.isMssqlDriver =
      exports.mssqlDriver =
      exports.isDuckdbDriver =
      exports.duckdbDriver =
      exports.isMongoDriver =
      exports.mongoDriver =
      exports.isMysqlDriver =
      exports.planetscaleDriver =
      exports.mariadbDriver =
      exports.mysql2Driver =
      exports.isPostgresDriver =
      exports.postgresJsDriver =
      exports.pgDriver =
      exports.isWasmSqliteDriver =
      exports.wasmSqliteDriver =
      exports.isSqliteDriver =
      exports.tauriSqlDriver =
      exports.libsqlDriver =
      exports.opSqliteDriver =
      exports.expoSqliteDriver =
      exports.betterSqlite3Driver =
      exports.createDb =
        void 0;
    exports.applySqliteMigration =
      exports.buildSqliteSchemaDDL =
      exports.browserDoctor =
      exports.applyDrift =
      exports.runMigrate =
      exports.parseIgnoreList =
      exports.formatDriftReport =
      exports.expectedFromSchema =
      exports.diffIntrospection =
      exports.DbKnownError =
      exports.RevisionEmbed =
      exports.SocialLinkEmbed =
      exports.AddressEmbed =
      exports.LikeKind =
      ...
      exports.dbClient =
      exports.wireOtel =
      exports.ForgeEmitter =
      exports.compileSqlFragment =
      exports.isSqlFragment =
      exports.forgeSql =
      exports.buildPostgresCompileApi =
      exports.getActiveSchema =
        void 0;
    ...
    var driver_1 = require_driver3();
    Object.defineProperty(exports, "betterSqlite3Driver", {
      enumerable: true,
      get: function () {
        return driver_1.betterSqlite3Driver;
      },
    });
    Object.defineProperty(exports, "expoSqliteDriver", {
      enumerable: true,
      get: function () {
        return driver_1.expoSqliteDriver;
      },
    });
    Object.defineProperty(exports, "opSqliteDriver", {
      enumerable: true,
      get: function () {
        return driver_1.opSqliteDriver;
      },
    });
    Object.defineProperty(exports, "libsqlDriver", {
      enumerable: true,
      get: function () {
        return driver_1.libsqlDriver;
      },
    });
    Object.defineProperty(exports, "tauriSqlDriver", {
      enumerable: true,
      get: function () {
        return driver_1.tauriSqlDriver;
      },
    });
    Object.defineProperty(exports, "isSqliteDriver", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "wasmSqliteDriver", {
      enumerable: true,
      get: function () {
        return wasm_driver_1.wasmSqliteDriver;
      },
    });
    Object.defineProperty(exports, "isWasmSqliteDriver", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "pgDriver", {
      enumerable: true,
      get: function () {
        return driver_2.pgDriver;
      },
    });
    Object.defineProperty(exports, "postgresJsDriver", {
      enumerable: true,
      get: function () {
        return driver_2.postgresJsDriver;
      },
    });
    Object.defineProperty(exports, "isPostgresDriver", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "mysql2Driver", {
      enumerable: true,
      get: function () {
        return driver_3.mysql2Driver;
      },
    });
    Object.defineProperty(exports, "mariadbDriver", {
      enumerable: true,
      get: function () {
        return driver_3.mariadbDriver;
      },
    });
    Object.defineProperty(exports, "planetscaleDriver", {
      enumerable: true,
      get: function () {
        return driver_3.planetscaleDriver;
      },
    });
    Object.defineProperty(exports, "isMysqlDriver", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "mongoDriver", {
      enumerable: true,
      get: function () {
        return driver_4.mongoDriver;
      },
    });
    Object.defineProperty(exports, "isMongoDriver", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "duckdbDriver", {
      enumerable: true,
      get: function () {
        return driver_5.duckdbDriver;
      },
    });
    Object.defineProperty(exports, "isDuckdbDriver", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "mssqlDriver", {
      enumerable: true,
      get: function () {
        return driver_6.mssqlDriver;
      },
    });
    Object.defineProperty(exports, "isMssqlDriver", {
      enumerable: true,
      get: function () {
    ...
    var missing_driver_1 = require_missing_driver();
    Object.defineProperty(exports, "ForgeMissingDriverError", {
      enumerable: true,
      get: function () {
    ...
    var detect_1 = require_detect();
    Object.defineProperty(exports, "detectAdapterKind", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "buildCount", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "buildGroupBy", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "isColRef", {
      enumerable: true,
      get: function () {
        return col_1.isColRef;
      },
    });
    Object.defineProperty(exports, "FORGE_COL", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "ForgeDbNull", {
      enumerable: true,
      get: function () {
        return null_markers_1.ForgeDbNull;
      },
    });
    Object.defineProperty(exports, "ForgeJsonNull", {
      enumerable: true,
      get: function () {
        return null_markers_1.ForgeJsonNull;
      },
    });
    Object.defineProperty(exports, "ForgeAnyNull", {
      enumerable: true,
      get: function () {
        return null_markers_1.ForgeAnyNull;
      },
    });
    Object.defineProperty(exports, "isForgeNullMarker", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "forgeValidator", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "rel", {
      enumerable: true,
      get: function () {
        return core_1.rel;
      },
    ...
    var schema_1 = require_schema();
    Object.defineProperty(exports, "sampleSchema", {
      enumerable: true,
      get: function () {
    ...
    var active_1 = require_active();
    Object.defineProperty(exports, "setActiveSchema", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "buildPostgresCompileApi", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "forgeSql", {
      enumerable: true,
      get: function () {
        return raw_sql_1.forgeSql;
      },
    });
    Object.defineProperty(exports, "isSqlFragment", {
      enumerable: true,
      get: function () {
        return raw_sql_1.isSqlFragment;
      },
    });
    Object.defineProperty(exports, "compileSqlFragment", {
      enumerable: true,
      get: function () {
    ...
    var events_1 = require_events();
    Object.defineProperty(exports, "ForgeEmitter", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "wireOtel", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "LikeKind", {
      enumerable: true,
      get: function () {
        return schema_2.LikeKind;
      },
    });
    Object.defineProperty(exports, "AddressEmbed", {
      enumerable: true,
      get: function () {
        return schema_2.AddressEmbed;
      },
    });
    Object.defineProperty(exports, "SocialLinkEmbed", {
      enumerable: true,
      get: function () {
        return schema_2.SocialLinkEmbed;
      },
    });
    Object.defineProperty(exports, "RevisionEmbed", {
      enumerable: true,
      get: function () {
    ...
    var diff_core_1 = require_diff_core();
    Object.defineProperty(exports, "diffIntrospection", {
      enumerable: true,
      get: function () {
        return diff_core_1.diffIntrospection;
      },
    });
    Object.defineProperty(exports, "expectedFromSchema", {
      enumerable: true,
      get: function () {
        return diff_core_1.expectedFromSchema;
      },
    });
    Object.defineProperty(exports, "formatDriftReport", {
      enumerable: true,
      get: function () {
        return diff_core_1.formatDriftReport;
      },
    });
    Object.defineProperty(exports, "parseIgnoreList", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "runMigrate", {
      enumerable: true,
      get: function () {
    ...
    var drift_apply_1 = require_drift_apply();
    Object.defineProperty(exports, "applyDrift", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "browserDoctor", {
      enumerable: true,
      get: function () {
    ...
    var ddl_1 = require_ddl2();
    Object.defineProperty(exports, "buildSqliteSchemaDDL", {
      enumerable: true,
      get: function () {
    ...
    Object.defineProperty(exports, "applySqliteMigration", {
      enumerable: true,
      get: function () {
...
var Nn = T((Qt) => {
  ...
  Qt.read = function (r, e, t, n, i) {
    var s,
      ...
      A = r[e + y];
    for (
      y += g, s = A & ((1 << -f3) - 1), A >>= -f3, f3 += u;
      f3 > 0;
      s = s * 256 + r[e + y], y += g, f3 -= 8
    );
    for (
      o = s & ((1 << -f3) - 1), s >>= -f3, f3 += n;
      f3 > 0;
      o = o * 256 + r[e + y], y += g, f3 -= 8
    );
    if (s === 0) s = 1 - l;
    else {
      ...
      e = Math.abs(e),
        isNaN(e) || e === 1 / 0
          ...
          : ((o = Math.floor(Math.log(e) / Math.LN2)),
            ...
            o + y >= 1 ? (e += g / c) : (e += g * Math.pow(2, 1 - y)),
            e * c >= 2 && (o++, (c /= 2)),
            o + y >= f3
              ? ((u = 0), (o = f3))
              : o + y >= 1
...
var ii = T((Be) => {
  ...
  a(Do, "fromString");
  function Wt(r) {
    let e = r.length < 0 ? 0 : Gt(r.length) | 0,
      t = he(e);
  ...
  function ei(r, e, t, n, i) {
    return (
      (e = +e),
      (t = t >>> 0),
      i || Xn(r, e, t, 4, 34028234663852886e22, -34028234663852886e22),
  ...
  function ti(r, e, t, n, i) {
    return (
      (e = +e),
      (t = t >>> 0),
      i || Xn(r, e, t, 8, 17976931348623157e292, -17976931348623157e292),
  ...
  function je(r, e, t) {
    throw Math.floor(r) !== r
      ? (Re(r, t), new Te.ERR_OUT_OF_RANGE(t || "offset", "an integer", r))
      : e < 0
...
var ge = T((Bl, Kt) => {
  ...
  R.prototype.emit = a(function (e) {
    ...
    if (typeof c == "function") si(c, this, t);
      ...
      for (var l = c.length, f3 = pi(c, l), n = 0; n < l; ++n)
        si(f3[n], this, t);
    return true;
  }, "emit");
  function ci(r, e, t, n) {
    ...
    (S = class S2 extends mi.EventEmitter {
      ...
      connect(t, n, i) {
        ...
        try {
          ...
          fetch(f3, { headers: { Upgrade: "websocket" } })
            .then((y) => {
...
function Yt(r, e = false) {
  ...
  let A = i + ":" + s,
    C = e ? Object.fromEntries(y.entries()) : f3;
  return {
    href: r,
    protocol: t,
    auth: A,
...
var Ti = T((ef, Ii) => {
  ...
  Ii.exports = a(function (e) {
    ...
    return (
      g != null
        ? ((y = new Date(Date.UTC(i, s, o, u, c, l, f3))),
          nr(i) && y.setUTCFullYear(i),
          g !== 0 && y.setTime(y.getTime() - g))
        : ((y = new Date(i, s, o, u, c, l, f3)), nr(i) && y.setFullYear(i)),
      y
    );
  }, "parseDate");
  function Ba(r) {
...
var Fi = T((af, Li) => {
  ...
  function Va(r) {
    ...
    return Object.keys(Bi).reduce(function (n, i) {
      ...
      return (
        !o ||
          ((o = i === "milliseconds" ? Ga(o) : parseInt(o, 10)), !o) ||
...
var Ki = T((bf, zi) => {
  ...
  var nu = Hi(),
    L = a(function (r, e, t, n, i) {
      ...
      for (var f3 = (e + t) >> 3, y = s + 1; y < f3; y++) l = i(l, o(r[y]), 8);
      var g = (e + t) % 8;
    ...
    au = a(function (r) {
      ...
      for (
        var t = Math.pow(1e4, L(r, 16, 16)), n = 0, i = [], s = L(r, 16), o = 0;
        o < s;
        o++
      )
    ...
    Ke = a(function (r) {
      ...
      var u = a(function (l) {
          ...
          var y;
          if (l == 23 || l == 20)
            return ((y = L(r, f3 * 8, i)), (i += f3 * 8), y);
          if (l == 25)
            return (
              (y = r.toString(this.encoding, i >> 3, (i += f3 << 3) >> 3)),
              y
            );
...
function Xe(r) {
  let e = 1779033703,
    ...
    C = new Uint8Array(64),
    D = a(() => {
      for (let B = 0, j = 0; B < 16; B++, j += 4)
        A[B] = (C[j] << 24) | (C[j + 1] << 16) | (C[j + 2] << 8) | C[j + 3];
      for (let B = 16; B < 64; B++) {
        let j = g(A[B - 15], 7) ^ g(A[B - 15], 18) ^ (A[B - 15] >>> 3),
          le = g(A[B - 2], 17) ^ g(A[B - 2], 19) ^ (A[B - 2] >>> 10);
      ...
      let I = e,
        ...
        oe = c;
      for (let B = 0; B < 64; B++) {
        let j = g(J, 6) ^ g(J, 11) ^ g(J, 25),
          le = (J & X) ^ (~J & se),
          de = (oe + j + le + y[B] + A[B]) | 0,
    ...
    P = a(() => {
      ...
      for (; f3 < 58; ) C[f3++] = 0;
      let I = l * 8;
      ((C[f3++] = (I / 1099511627776) & 255),
        (C[f3++] = (I / 4294967296) & 255),
        (C[f3++] = I >>> 24),
        (C[f3++] = (I >>> 16) & 255),
        (C[f3++] = (I >>> 8) & 255),
        (C[f3++] = I & 255),
...
`);
  ...
  var oc = (pe.exports.match = function (r, e) {
    return De.slice(0, -1).reduce(function (t, n, i) {
      return i == 1 && Number(r[n] || Xu) === Number(e[n])
        ? t && true
        : t && (e[n] === "*" || e[n] === r[n]);
    }, true);
  });
...
var Rt = T((Ah, Ls) => {
  ...
  var fc = (Is(), O(_s)),
    ...
    Rr = class Rr {
      constructor(e) {
        ((e = typeof e == "string" ? Rs(e) : e || {}),
          e.connectionString &&
            (e = Object.assign({}, e, Rs(e.connectionString))),
          (this.user = H("user", e)),
          (this.database = H("database", e)),
          this.database === void 0 && (this.database = this.user),
          (this.port = parseInt(H("port", e), 10)),
          (this.host = H("host", e)),
      ...
      getLibpqConnectionString(e) {
        ...
        (this.client_encoding &&
          ...
          fc.lookup(this.host, function (i, s) {
            return i
              ? e(i, null)
...
var Ws = T((Ft) => {
  ...
  var pn = Qs(),
    ...
    gc = a(function (r, e) {
      return (
        F.addCString(r).addInt32(d.byteLength(e)).addString(e),
        F.flush(112)
      );
    ...
    Bc = a((r) => F.add(r).flush(100), "copyData"),
  ...
  var Yc = ge().EventEmitter,
    ...
    Cn = class Cn extends Yc {
      ...
      _handleAuthSASLFinal(e) {
        (An.finalizeSession(this.saslSession, e.data),
        ...
        return (
          ...
          o &&
            ...
            (u = setTimeout(() => {
              ...
              (f3 > -1 && this.queryQueue.splice(f3, 1),
                this._pulseQueryQueue());
            }, o)),
            (i.callback = (l, f3) => {
          ...
          try {
            o.query(e, t, (l, f3) => {
              if (
                ...
                return ((u = true), o.release(l), l ? n(l) : n(void 0, f3));
            });
          } catch (l) {
...
var lo = T((fp, co) => {
  ...
  var uo = ge().EventEmitter,
    ...
    Ne = (co.exports = function (r, e, t) {
      (uo.call(this),
        (r = Bn.normalizeQueryConfig(r, e, t)),
        (this.text = r.text),
    ...
    for (let i = 0, s = t.length; i < s; i++)
      if (((e.query += t[i]), i < n.length)) {
        ...
        if (o instanceof Ge) e.query += o.sql;
          ...
          (u.push(o),
            (e.query += "$" + u.length),
            (o instanceof d || ArrayBuffer.isView(o)) &&
              (e.query += "::bytea"));
        }
      }
    return e;
...
function cs(
  ...
  if ((f3 !== "postgres:" && f3 !== "postgresql:") || !y || !g || !C)
    throw new Error(
  ...
  async function Y(P, I, w) {
    ...
    (w !== void 0 &&
      ...
      w.isolationLevel !== void 0 && (B = w.isolationLevel),
    ...
    let We = typeof Z == "function" ? Z(g, A, { jwtAuth: de !== void 0 }) : Z,
      fe = {
    ...
    (_e && (fe.Authorization = `Bearer ${_e}`),
      Array.isArray(P) &&
        (B !== void 0 && (fe["Neon-Batch-Isolation-Level"] = B),
...
var kn = class kn2 extends wo.Client {
  ...
  async _handleAuthSASLContinue(t) {
    ...
    var le = new Uint8Array(await n.sign("HMAC", j, A.encode(B))),
...
function getJoin(schema, tableName, propertyName) {
  const isArray =
    schema.definitions[tableName].properties[propertyName].type === "array";
...
function isInfiniteRecursion(functionName, maxCalls = 100) {
  ...
  const isInfiniteLoop =
    trace.filter(forFunction(functionName)).length > maxCalls;
...
async function createWebClient({
  ...
  try {
    ...
    if (isNodeJs) {
      const dotenv = await import(".pnpm/dotenv@17.4.2/node_modules/dotenv");
      dotenv.config();
